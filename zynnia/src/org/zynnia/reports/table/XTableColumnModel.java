...
public class XTableColumnModel extends DefaultTableColumnModel {
    ...
    public TableColumn getVisibleColumnByModelIndex(int modelColumnIndex) {
//		for (int columnIndex = 0; columnIndex < tableColumns.size(); ++columnIndex) {
//			TableColumn column = (TableColumn) tableColumns.elementAt(columnIndex);
//			if (column.getModelIndex() == modelColumnIndex) {
//				return column;
//			}
//		}
        if (modelColumnIndex >= 0 && modelColumnIndex < tableColumns.size()) {
            TableColumn column = (TableColumn) tableColumns.elementAt(modelColumnIndex);
            return column;
        }
		return null;
	}
