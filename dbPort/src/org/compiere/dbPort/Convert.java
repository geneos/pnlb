...
public class Convert
{
        ...
        private ArrayList<String> convertStatement (String sqlStatement)
	{
		...
		String statement = removeComments (sqlStatement);
                //String statement = removeComments (sqlStatement).toUpperCase();
                // begin vpj-cd e-evolution 07/12/2005 PostgreSQL
	...
	//	log.info("------------------------------------------------------------");
//		begin vpj-cd e-evolution 06/21/2005 PostgreSQL
		//result.add(convertAlias(statement));
		//end vpj-cd e-evolution 02/21/2005 PostgreSQL
		return result;
	}   //  convertStatement
...
**/
	 ...
	 *  </pre>*/
		...
		//begin vpj-cd e-evolution 07/12/2005 PostgreSQL
		{	
			retValue = new StringBuffer ("DATE_Part(");		
