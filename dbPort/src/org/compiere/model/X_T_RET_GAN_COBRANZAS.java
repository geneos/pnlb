...
/**
 * Generated Model for T_RET_GAN_COBRANZAS
 * 
 * @author Jorg Janke (generated)
 * @version Release 2.5.3b - 2008-04-04 14:06:05.14
 */
public class X_T_RET_GAN_COBRANZAS extends PO {
	/** Standard Constructor */
	public X_T_RET_GAN_COBRANZAS(Properties ctx, int T_RET_GAN_COBRANZAS_ID,
			String trxName) {
		super(ctx, T_RET_GAN_COBRANZAS_ID, trxName);
		/**
		 * if (T_RET_GAN_COBRANZAS_ID == 0) { }
		 */
	}

	/** Load Constructor */
	public X_T_RET_GAN_COBRANZAS(Properties ctx, ResultSet rs, String trxName) {
		super(ctx, rs, trxName);
	}

	/** TableName=T_RET_GAN_COBRANZAS */
	public static final String Table_Name = "T_RET_GAN_COBRANZAS";
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_T_RET_GAN_COBRANZAS[").append(
				get_ID()).append("]");
		return sb.toString();
	}
