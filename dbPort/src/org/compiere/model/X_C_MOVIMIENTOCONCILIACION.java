...
public class X_C_MOVIMIENTOCONCILIACION extends PO {
	/** Standard Constructor */
	public X_C_MOVIMIENTOCONCILIACION(Properties ctx,
			int C_MOVIMIENTOCONCILIACION_ID, String trxName) {
		super(ctx, C_MOVIMIENTOCONCILIACION_ID, trxName);
	}

	/** Load Constructor */
	public X_C_MOVIMIENTOCONCILIACION(Properties ctx, ResultSet rs,
			String trxName) {
		super(ctx, rs, trxName);
	}

	/** TableName=C_BankStatementLine */
	public static final String Table_Name = "C_MOVIMIENTOCONCILIACION";
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_MOVIMIENTOCONCILIACION[")
	 ...
	 */
	public void setC_MOVIMIENTOCONCILIACION_ID(int C_MOVIMIENTOCONCILIACION_ID) {
		if (C_MOVIMIENTOCONCILIACION_ID < 1)
			throw new IllegalArgumentException(
					"C_MOVIMIENTOCONCILIACION_ID is mandatory.");
		set_ValueNoCheck("C_MOVIMIENTOCONCILIACION_ID", new Integer(
				C_MOVIMIENTOCONCILIACION_ID));
	}

	/**
	 * Get Bank statement line. Line on a statement from this Bank
	 */
	public int getC_MOVIMIENTOCONCILIACION_ID() {
		Integer ii = (Integer) get_Value("C_MOVIMIENTOCONCILIACION_ID");
		if (ii == null)
			return 0;
		return ii.intValue();
	}
	...
	public void setConciliado(boolean conciliado) {
		set_Value("CONCILIADO", new Boolean(conciliado));
	}
	...
	public boolean getConciliado() {
		Object oo = get_Value("CONCILIADO");
		if (oo != null) {
	...
	public void setOld(boolean old) {
		set_Value("OLDPENDIENTE", new Boolean(old));
	}
	...
	public boolean getOld() {
		Object oo = get_Value("OLDPENDIENTE");
		if (oo != null) {
			if (oo instanceof Boolean)
				return ((Boolean) oo).booleanValue();
			return "Y".equals(oo);
	...
	public void setRELEASEDATE(Timestamp releaseDate) {
		set_Value("RELEASEDATE", releaseDate);
	}
	...
	public Timestamp getRELEASEDATE() {
		return (Timestamp) get_Value("RELEASEDATE");
	}
