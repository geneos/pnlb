 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:57.5
 */
public class X_AD_TreeNode extends PO {
	...
	public X_AD_TreeNode(Properties ctx, int AD_TreeNode_ID, String trxName) {
		...
		/**
		 * if (AD_TreeNode_ID == 0) { setAD_Tree_ID (0); setNode_ID (0);
		 * setSeqNo (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_TreeNode[").append(get_ID())
				.append("]");
		return sb.toString();
	}
