 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:56.078
 */
public class X_AD_AlertProcessorLog extends PO {
	/** Standard Constructor */
	public X_AD_AlertProcessorLog(Properties ctx, int AD_AlertProcessorLog_ID,
			String trxName) {
		super(ctx, AD_AlertProcessorLog_ID, trxName);
		/**
		 * if (AD_AlertProcessorLog_ID == 0) { setAD_AlertProcessorLog_ID (0);
		 * setAD_AlertProcessor_ID (0); setIsError (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_AlertProcessorLog[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setAD_AlertProcessorLog_ID(int AD_AlertProcessorLog_ID) {
		if (AD_AlertProcessorLog_ID < 1)
			throw new IllegalArgumentException(
					"AD_AlertProcessorLog_ID is mandatory.");
		set_ValueNoCheck("AD_AlertProcessorLog_ID", new Integer(
