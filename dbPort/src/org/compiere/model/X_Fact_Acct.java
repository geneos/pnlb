 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:00.906
 */
public class X_Fact_Acct extends PO {
	...
	public X_Fact_Acct(Properties ctx, int Fact_Acct_ID, String trxName) {
		...
		System.out.println("Creando por X_Fact_Acct");
		/**
		 * if (Fact_Acct_ID == 0) { setAD_Table_ID (0); setAccount_ID (0);
		 * setAmtAcctCr (Env.ZERO); setAmtAcctDr (Env.ZERO); setAmtSourceCr
		 * (Env.ZERO); setAmtSourceDr (Env.ZERO); setC_AcctSchema_ID (0);
		 * setC_Currency_ID (0); setC_Period_ID (0); setDateAcct (new
		 * Timestamp(System.currentTimeMillis())); setDateTrx (new
		 * Timestamp(System.currentTimeMillis())); setFact_Acct_ID (0);
		 * setGL_Category_ID (0); setPostingType (null); setRecord_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_Fact_Acct[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setC_Campaign_ID(int C_Campaign_ID) {
		if (C_Campaign_ID <= 0)
			set_ValueNoCheck("C_Campaign_ID", null);
		else
	...
	public void setC_SalesRegion_ID(int C_SalesRegion_ID) {
		if (C_SalesRegion_ID <= 0)
			set_ValueNoCheck("C_SalesRegion_ID", null);
		else
	...
	public void setC_SubAcct_ID(int C_SubAcct_ID) {
		if (C_SubAcct_ID <= 0)
			set_Value("C_SubAcct_ID", null);
		else
			set_Value("C_SubAcct_ID", new Integer(C_SubAcct_ID));
	}
	...
	public void setGL_Budget_ID(int GL_Budget_ID) {
		if (GL_Budget_ID <= 0)
			set_ValueNoCheck("GL_Budget_ID", null);
		else
	...
	public void setUser1_ID(int User1_ID) {
		if (User1_ID <= 0)
			set_ValueNoCheck("User1_ID", null);
		else
	...
	public void setUser2_ID(int User2_ID) {
		if (User2_ID <= 0)
			set_ValueNoCheck("User2_ID", null);
		else
	...
	public void setUserElement1_ID(int UserElement1_ID) {
		if (UserElement1_ID <= 0)
			set_ValueNoCheck("UserElement1_ID", null);
		else
			set_ValueNoCheck("UserElement1_ID", new Integer(UserElement1_ID));
	}
	...
	public void setUserElement2_ID(int UserElement2_ID) {
		if (UserElement2_ID <= 0)
			set_ValueNoCheck("UserElement2_ID", null);
		else
			set_ValueNoCheck("UserElement2_ID", new Integer(UserElement2_ID));
	}
