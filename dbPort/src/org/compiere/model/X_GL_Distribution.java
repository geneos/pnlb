 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.015
 */
public class X_GL_Distribution extends PO {
	...
	public X_GL_Distribution(Properties ctx, int GL_Distribution_ID,
		...
		/**
		 * if (GL_Distribution_ID == 0) { setAnyAcct (true); // Y setAnyActivity
		 * (true); // Y setAnyBPartner (true); // Y setAnyCampaign (true); // Y
		 * setAnyLocFrom (true); // Y setAnyLocTo (true); // Y setAnyOrg (true); //
		 * Y setAnyOrgTrx (true); // Y setAnyProduct (true); // Y setAnyProject
		 * (true); // Y setAnySalesRegion (true); // Y setAnyUser1 (true); // Y
		 * setAnyUser2 (true); // Y setC_AcctSchema_ID (0);
		 * setGL_Distribution_ID (0); setIsValid (false); // N setName (null);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_GL_Distribution[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Any Trx Organization. Match any value of the Transaction Organization
	 * segment
	 */
	...
	/**
	 * Get Any Trx Organization. Match any value of the Transaction Organization
	 * segment
	 */
