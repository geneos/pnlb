...
/**
 * Generated Model for MPC_Order_BOM
 * 
 * @author Jorg Janke (generated)
 * @version Release 2.5.3b - 2008-04-04 14:06:01.906
 */
public class X_MPC_Order_BOM extends PO {
	...
	public X_MPC_Order_BOM(Properties ctx, int MPC_Order_BOM_ID, String trxName) {
		...
		/**
		 * if (MPC_Order_BOM_ID == 0) { setC_UOM_ID (0); setMPC_Order_BOM_ID
		 * (0); setMPC_Order_ID (0); setM_Product_ID (0); setName (null);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_MPC_Order_BOM[").append(get_ID())
				.append("]");
		return sb.toString();
	}
