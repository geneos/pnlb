 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.218
 */
public class X_I_BankStatement extends PO {
	...
	public X_I_BankStatement(Properties ctx, int I_BankStatement_ID,
		...
		/**
		 * if (I_BankStatement_ID == 0) { setI_BankStatement_ID (0);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_BankStatement[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setC_BankStatementLine_ID(int C_BankStatementLine_ID) {
		if (C_BankStatementLine_ID <= 0)
			set_Value("C_BankStatementLine_ID", null);
		else
			set_Value("C_BankStatementLine_ID", new Integer(
	...
	public void setC_BankStatement_ID(int C_BankStatement_ID) {
		if (C_BankStatement_ID <= 0)
			set_Value("C_BankStatement_ID", null);
		else
	...
	public void setI_BankStatement_ID(int I_BankStatement_ID) {
		if (I_BankStatement_ID < 1)
			throw new IllegalArgumentException(
					"I_BankStatement_ID is mandatory.");
