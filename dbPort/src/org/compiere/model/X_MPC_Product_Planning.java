...
/**
 * Generated Model for MPC_Product_Planning
 * 
 * @author Jorg Janke (generated)
 * @version Release 2.5.3b - 2008-04-04 14:06:02.203
 */
public class X_MPC_Product_Planning extends PO {
	/** Standard Constructor */
	public X_MPC_Product_Planning(Properties ctx, int MPC_Product_Planning_ID,
			String trxName) {
		super(ctx, MPC_Product_Planning_ID, trxName);
		/**
		 * if (MPC_Product_Planning_ID == 0) { setIsCreatePlan (false);
		 * setIsIssue (true); // Y setIsPhantom (false); setIsRequiredMRP
		 * (false); setMPC_Product_Planning_ID (0); setM_Product_ID (0);
		 * setM_Warehouse_ID (0); setS_Resource_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_MPC_Product_Planning[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setMPC_Product_Planning_ID(int MPC_Product_Planning_ID) {
		if (MPC_Product_Planning_ID < 1)
			throw new IllegalArgumentException(
					"MPC_Product_Planning_ID is mandatory.");
		set_ValueNoCheck("MPC_Product_Planning_ID", new Integer(
				MPC_Product_Planning_ID));
	}
	...
	/** Order_Policy AD_Reference_ID=1000015 */
