 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.406
 */
public class X_C_AcctProcessorLog extends PO {
	...
	public X_C_AcctProcessorLog(Properties ctx, int C_AcctProcessorLog_ID,
		 ...
		 * setC_AcctProcessor_ID (0); setIsError (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_AcctProcessorLog[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Accounting Processor Log. Result of the execution of the Accounting
	 * Processor
	 */
	public void setC_AcctProcessorLog_ID(int C_AcctProcessorLog_ID) {
		if (C_AcctProcessorLog_ID < 1)
			throw new IllegalArgumentException(
					"C_AcctProcessorLog_ID is mandatory.");
		set_ValueNoCheck("C_AcctProcessorLog_ID", new Integer(
				C_AcctProcessorLog_ID));
	}

	/**
	 * Get Accounting Processor Log. Result of the execution of the Accounting
	 * Processor
	 */
	...
	public void setC_AcctProcessor_ID(int C_AcctProcessor_ID) {
		if (C_AcctProcessor_ID < 1)
			throw new IllegalArgumentException(
					"C_AcctProcessor_ID is mandatory.");
