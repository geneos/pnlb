 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:04.859
 */
public class X_T_Aging extends PO {
	...
	public X_T_Aging(Properties ctx, int T_Aging_ID, String trxName) {
		...
		/**
		 * if (T_Aging_ID == 0) { setAD_PInstance_ID (0); setC_BP_Group_ID (0);
		 * setC_BPartner_ID (0); setC_Currency_ID (0);
		 * setC_InvoicePaySchedule_ID (0); // 0 setC_Invoice_ID (0); setDue0
		 * (Env.ZERO); setDue0_30 (Env.ZERO); setDue0_7 (Env.ZERO); setDue1_7
		 * (Env.ZERO); setDue31_60 (Env.ZERO); setDue31_Plus (Env.ZERO);
		 * setDue61_90 (Env.ZERO); setDue61_Plus (Env.ZERO); setDue8_30
		 * (Env.ZERO); setDue91_Plus (Env.ZERO); setDueAmt (Env.ZERO);
		 * setDueDate (new Timestamp(System.currentTimeMillis()));
		 * setInvoicedAmt (Env.ZERO); setIsListInvoices (false); setIsSOTrx
		 * (false); setOpenAmt (Env.ZERO); setPastDue1_30 (Env.ZERO);
		 * setPastDue1_7 (Env.ZERO); setPastDue31_60 (Env.ZERO);
		 * setPastDue31_Plus (Env.ZERO); setPastDue61_90 (Env.ZERO);
		 * setPastDue61_Plus (Env.ZERO); setPastDue8_30 (Env.ZERO);
		 * setPastDue91_Plus (Env.ZERO); setPastDueAmt (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_T_Aging[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setC_InvoicePaySchedule_ID(int C_InvoicePaySchedule_ID) {
		...
		set_Value("C_InvoicePaySchedule_ID", new Integer(
	...
	public void setDue0(BigDecimal Due0) {
		if (Due0 == null)
			throw new IllegalArgumentException("Due0 is mandatory.");
		set_Value("Due0", Due0);
	}
	...
	public void setDue0_30(BigDecimal Due0_30) {
		if (Due0_30 == null)
			throw new IllegalArgumentException("Due0_30 is mandatory.");
	...
	public void setDue0_7(BigDecimal Due0_7) {
		if (Due0_7 == null)
			throw new IllegalArgumentException("Due0_7 is mandatory.");
	...
	public void setDue1_7(BigDecimal Due1_7) {
		if (Due1_7 == null)
			throw new IllegalArgumentException("Due1_7 is mandatory.");
	...
	public void setDue31_Plus(BigDecimal Due31_Plus) {
		if (Due31_Plus == null)
			throw new IllegalArgumentException("Due31_Plus is mandatory.");
	...
	public void setDue61_Plus(BigDecimal Due61_Plus) {
		if (Due61_Plus == null)
			throw new IllegalArgumentException("Due61_Plus is mandatory.");
	...
	public void setDue8_30(BigDecimal Due8_30) {
		if (Due8_30 == null)
			throw new IllegalArgumentException("Due8_30 is mandatory.");
	...
	public void setDue91_Plus(BigDecimal Due91_Plus) {
		if (Due91_Plus == null)
			throw new IllegalArgumentException("Due91_Plus is mandatory.");
	...
	public void setPastDue1_30(BigDecimal PastDue1_30) {
		if (PastDue1_30 == null)
			throw new IllegalArgumentException("PastDue1_30 is mandatory.");
	...
	public void setPastDue1_7(BigDecimal PastDue1_7) {
		if (PastDue1_7 == null)
			throw new IllegalArgumentException("PastDue1_7 is mandatory.");
	...
	public void setPastDue31_Plus(BigDecimal PastDue31_Plus) {
		if (PastDue31_Plus == null)
			throw new IllegalArgumentException("PastDue31_Plus is mandatory.");
	...
	public void setPastDue61_Plus(BigDecimal PastDue61_Plus) {
		if (PastDue61_Plus == null)
			throw new IllegalArgumentException("PastDue61_Plus is mandatory.");
	...
	public void setPastDue8_30(BigDecimal PastDue8_30) {
		if (PastDue8_30 == null)
			throw new IllegalArgumentException("PastDue8_30 is mandatory.");
	...
	public void setPastDue91_Plus(BigDecimal PastDue91_Plus) {
		if (PastDue91_Plus == null)
			throw new IllegalArgumentException("PastDue91_Plus is mandatory.");
