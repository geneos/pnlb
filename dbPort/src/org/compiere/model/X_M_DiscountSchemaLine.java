...
public class X_M_DiscountSchemaLine extends PO {
	...
	public X_M_DiscountSchemaLine(Properties ctx, int M_DiscountSchemaLine_ID,
		 ...
		 * 
		 * @#Date@ setLimit_AddAmt (Env.ZERO); setLimit_Base (null); // X
		 *         setLimit_Discount (Env.ZERO); setLimit_MaxAmt (Env.ZERO);
		 *         setLimit_MinAmt (Env.ZERO); setLimit_Rounding (null); // C
		 *         setList_AddAmt (Env.ZERO); setList_Base (null); // L
		 *         setList_Discount (Env.ZERO); setList_MaxAmt (Env.ZERO);
		 *         setList_MinAmt (Env.ZERO); setList_Rounding (null); // C
		 *         setM_DiscountSchemaLine_ID (0); setM_DiscountSchema_ID (0);
		 *         setSeqNo (0); //
		 * @SQL=SELECT NVL(MAX(SeqNo),0)+10 AS DefaultValue FROM
		 *             M_DiscountSchemaLine WHERE
		 *             M_DiscountSchema_ID=@M_DiscountSchema_ID@ setStd_AddAmt
		 *             (Env.ZERO); setStd_Base (null); // S setStd_Discount
		 *             (Env.ZERO); setStd_MaxAmt (Env.ZERO); setStd_MinAmt
		 *             (Env.ZERO); setStd_Rounding (null); // C }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_DiscountSchemaLine[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Limit price Surcharge Amount. Amount added to the converted/copied
	...
	/**
	 * Get Limit price Surcharge Amount. Amount added to the converted/copied
	 * price before multiplying
	 */
	...
	public void setLimit_Base(String Limit_Base) {
		if (Limit_Base == null)
			throw new IllegalArgumentException("Limit_Base is mandatory");
		if (Limit_Base.equals("F") || Limit_Base.equals("L")
				|| Limit_Base.equals("S") || Limit_Base.equals("X"))
			;
		else
			throw new IllegalArgumentException("Limit_Base Invalid value - "
					+ Limit_Base + " - Reference_ID=194 - F - L - S - X");
	...
	/**
	 * Set Limit price Discount %. Discount in percent to be subtracted from
	 * base, if negative it will be added to base price
	 */
	...
	/**
	 * Get Limit price Discount %. Discount in percent to be subtracted from
	 * base, if negative it will be added to base price
	 */
	...
	/**
	 * Set Limit price max Margin. Maximum difference to original limit price;
	 * ignored if zero
	 */
	...
	/**
	 * Get Limit price max Margin. Maximum difference to original limit price;
	 * ignored if zero
	 */
	...
	/**
	 * Set Limit price min Margin. Minimum difference to original limit price;
	 * ignored if zero
	 */
	...
	/**
	 * Get Limit price min Margin. Minimum difference to original limit price;
	 * ignored if zero
	 */
	...
	public void setLimit_Rounding(String Limit_Rounding) {
		if (Limit_Rounding == null)
			throw new IllegalArgumentException("Limit_Rounding is mandatory");
		if (Limit_Rounding.equals("0") || Limit_Rounding.equals("5")
				|| Limit_Rounding.equals("C") || Limit_Rounding.equals("D")
				|| Limit_Rounding.equals("N") || Limit_Rounding.equals("Q")
				|| Limit_Rounding.equals("T"))
			;
		else
			throw new IllegalArgumentException(
					"Limit_Rounding Invalid value - " + Limit_Rounding
							+ " - Reference_ID=155 - 0 - 5 - C - D - N - Q - T");
	...
	public void setList_Base(String List_Base) {
		if (List_Base == null)
			throw new IllegalArgumentException("List_Base is mandatory");
		if (List_Base.equals("F") || List_Base.equals("L")
				|| List_Base.equals("S") || List_Base.equals("X"))
			;
		else
			throw new IllegalArgumentException("List_Base Invalid value - "
					+ List_Base + " - Reference_ID=194 - F - L - S - X");
	...
	public void setList_Rounding(String List_Rounding) {
		if (List_Rounding == null)
			throw new IllegalArgumentException("List_Rounding is mandatory");
		if (List_Rounding.equals("0") || List_Rounding.equals("5")
				|| List_Rounding.equals("C") || List_Rounding.equals("D")
				|| List_Rounding.equals("N") || List_Rounding.equals("Q")
				|| List_Rounding.equals("T"))
			;
		else
			throw new IllegalArgumentException("List_Rounding Invalid value - "
					+ List_Rounding
					+ " - Reference_ID=155 - 0 - 5 - C - D - N - Q - T");
	...
	public void setM_DiscountSchemaLine_ID(int M_DiscountSchemaLine_ID) {
		if (M_DiscountSchemaLine_ID < 1)
			throw new IllegalArgumentException(
					"M_DiscountSchemaLine_ID is mandatory.");
		set_ValueNoCheck("M_DiscountSchemaLine_ID", new Integer(
	...
	/**
	 * Set Standard price Surcharge Amount. Amount added to a price as a
	 * surcharge
	 */
	...
	/**
	 * Get Standard price Surcharge Amount. Amount added to a price as a
	 * surcharge
	 */
	...
	public void setStd_Base(String Std_Base) {
		if (Std_Base == null)
			throw new IllegalArgumentException("Std_Base is mandatory");
		if (Std_Base.equals("F") || Std_Base.equals("L")
				|| Std_Base.equals("S") || Std_Base.equals("X"))
			;
		else
			throw new IllegalArgumentException("Std_Base Invalid value - "
					+ Std_Base + " - Reference_ID=194 - F - L - S - X");
	...
	/**
	 * Set Standard price Discount %. Discount percentage to subtract from base
	 * price
	 */
	...
	/**
	 * Get Standard price Discount %. Discount percentage to subtract from base
	 * price
	 */
	...
	public void setStd_Rounding(String Std_Rounding) {
		if (Std_Rounding == null)
			throw new IllegalArgumentException("Std_Rounding is mandatory");
		if (Std_Rounding.equals("0") || Std_Rounding.equals("5")
				|| Std_Rounding.equals("C") || Std_Rounding.equals("D")
				|| Std_Rounding.equals("N") || Std_Rounding.equals("Q")
				|| Std_Rounding.equals("T"))
			;
		else
			throw new IllegalArgumentException("Std_Rounding Invalid value - "
					+ Std_Rounding
					+ " - Reference_ID=155 - 0 - 5 - C - D - N - Q - T");
