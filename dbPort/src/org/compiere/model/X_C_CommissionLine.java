 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:59.14
 */
public class X_C_CommissionLine extends PO {
	/** Standard Constructor */
	public X_C_CommissionLine(Properties ctx, int C_CommissionLine_ID,
			String trxName) {
		super(ctx, C_CommissionLine_ID, trxName);
		/**
		 * if (C_CommissionLine_ID == 0) { setAmtMultiplier (Env.ZERO);
		 * setAmtSubtract (Env.ZERO); setC_CommissionLine_ID (0);
		 * setC_Commission_ID (0); setCommissionOrders (false);
		 * setIsPositiveOnly (false); setLine (0); //
		 * 
		 * @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM C_CommissionLine
		 *             WHERE C_Commission_ID=@C_Commission_ID@ setQtyMultiplier
		 *             (Env.ZERO); setQtySubtract (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_CommissionLine[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setC_CommissionLine_ID(int C_CommissionLine_ID) {
		...
		set_ValueNoCheck("C_CommissionLine_ID",
				new Integer(C_CommissionLine_ID));
	}
	...
	/**
	 * Set Commission only specified Orders. Commission only Orders or Invoices,
	 * where this Sales Rep is entered
	 */
	...
	/**
	 * Get Commission only specified Orders. Commission only Orders or Invoices,
	 * where this Sales Rep is entered
	 */
	...
	/**
	 * Set Multiplier Quantity. Value to multiply quantities by for generating
	 * commissions.
	 */
	...
	/**
	 * Get Multiplier Quantity. Value to multiply quantities by for generating
	 * commissions.
	 */
