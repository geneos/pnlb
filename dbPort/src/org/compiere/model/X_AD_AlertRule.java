...
public class X_AD_AlertRule extends PO {
	...
	public X_AD_AlertRule(Properties ctx, int AD_AlertRule_ID, String trxName) {
		...
		/**
		 * if (AD_AlertRule_ID == 0) { setAD_AlertRule_ID (0); setAD_Alert_ID
		 * (0); setFromClause (null); setIsValid (true); // Y setName (null);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_AlertRule[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Other Clause. Other SQL Clause
	 */
	...
	/**
	 * Get Other Clause. Other SQL Clause
	 */
