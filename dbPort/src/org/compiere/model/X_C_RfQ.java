 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:00.437
 */
public class X_C_RfQ extends PO {
	...
	public X_C_RfQ(Properties ctx, int C_RfQ_ID, String trxName) {
		 ...
		 * 
		 * @$C_Currency_ID @ setC_RfQ_ID (0); setC_RfQ_Topic_ID (0);
		 *                 setDateResponse (new
		 *                 Timestamp(System.currentTimeMillis())); setDocumentNo
		 *                 (null); setIsInvitedVendorsOnly (false);
		 *                 setIsQuoteAllQty (false); setIsQuoteTotalAmt (false);
		 *                 setIsRfQResponseAccepted (true); // Y
		 *                 setIsSelfService (true); // Y setName (null);
		 *                 setProcessed (false); setQuoteType (null); // S
		 *                 setSalesRep_ID (0); }
		 */
	}
	...
	/**
	 * Set Quote All Quantities. Suppliers are requested to provide responses
	 * for all quantities
	 */
	...
	/**
	 * Get Quote All Quantities. Suppliers are requested to provide responses
	 * for all quantities
	 */
	...
	/**
	 * Set Quote Total Amt. The respnse can have just the total amount for the
	 * RfQ
	 */
	...
	/**
	 * Get Quote Total Amt. The respnse can have just the total amount for the
	 * RfQ
	 */
	...
	/**
	 * Set Responses Accepted. Are Resonses to the Request for Quotation
	 * accepted
	 */
	...
	/**
	 * Get Responses Accepted. Are Resonses to the Request for Quotation
	 * accepted
	 */
	...
	public void setQuoteType(String QuoteType) {
		if (QuoteType == null)
			throw new IllegalArgumentException("QuoteType is mandatory");
		if (QuoteType.equals("A") || QuoteType.equals("S")
				|| QuoteType.equals("T"))
			;
		else
			throw new IllegalArgumentException("QuoteType Invalid value - "
					+ QuoteType + " - Reference_ID=314 - A - S - T");
