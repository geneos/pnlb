 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.703
 */
public class X_C_BP_Relation extends PO {
	...
	public X_C_BP_Relation(Properties ctx, int C_BP_Relation_ID, String trxName) {
		 ...
		 * setC_BPartnerRelation_ID (0); setC_BPartnerRelation_Location_ID (0);
		 * setC_BPartner_ID (0); setIsBillTo (false); setIsPayFrom (false);
		 * setIsRemitTo (false); setIsShipTo (false); // N setName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_BP_Relation[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setC_BPartnerRelation_ID(int C_BPartnerRelation_ID) {
		if (C_BPartnerRelation_ID < 1)
			throw new IllegalArgumentException(
					"C_BPartnerRelation_ID is mandatory.");
	 ...
	 */
	public void setC_BPartnerRelation_Location_ID(
			int C_BPartnerRelation_Location_ID) {
		if (C_BPartnerRelation_Location_ID < 1)
			throw new IllegalArgumentException(
					"C_BPartnerRelation_Location_ID is mandatory.");
		set_Value("C_BPartnerRelation_Location_ID", new Integer(
