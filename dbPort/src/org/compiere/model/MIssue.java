 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MIssue.java,v 1.2 2006/01/03 02:40:32 jjanke Exp $
 */
public class MIssue extends X_AD_Issue
{
	 ...
	 *	@param ctx context
	 *	@param decodedHashMap string
	 *	@return issue
	 */
	@SuppressWarnings("unchecked")
	public static MIssue create (Properties ctx, String decodedHashMap)
	{
		HashMap hmIn = null;
		try
		{
			String serIn = URLDecoder.decode(decodedHashMap, "UTF-8");
			ByteArrayInputStream bIn = new ByteArrayInputStream(serIn.getBytes());
	...
	private static final int	INFOLENGTH = 1000;
	...
	public String report()
	{
		...
		if (getRecord_ID() == 1)	//	new
		{
			...
			try
			{
				...
				oOut.flush();
				String serOut = bOut.toString();
				parameter.append(URLEncoder.encode(serOut, "UTF-8"));
			}
			catch (Exception e) 
			{
