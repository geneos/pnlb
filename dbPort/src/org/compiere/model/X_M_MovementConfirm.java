 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:03.156
 */
public class X_M_MovementConfirm extends PO {
	...
	public X_M_MovementConfirm(Properties ctx, int M_MovementConfirm_ID,
		...
		/**
		 * if (M_MovementConfirm_ID == 0) { setDocAction (null); setDocStatus
		 * (null); setDocumentNo (null); setIsApproved (false); // N
		 * setM_MovementConfirm_ID (0); setM_Movement_ID (0); setProcessed
		 * (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_MovementConfirm[").append(
				get_ID()).append("]");
		return sb.toString();
	}
