...
public class X_AD_LabelPrinter extends PO {
	...
	public X_AD_LabelPrinter(Properties ctx, int AD_LabelPrinter_ID,
			String trxName) {
		super(ctx, AD_LabelPrinter_ID, trxName);
		/**
		 * if (AD_LabelPrinter_ID == 0) { setAD_LabelPrinter_ID (0); setName
		 * (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_LabelPrinter[").append(
				get_ID()).append("]");
		return sb.toString();
	}
