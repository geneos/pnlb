...
/**
 * Generated Model for I_Role_Access
 * 
...
public class X_I_Role_Access extends PO {
	...
	public X_I_Role_Access(Properties ctx, int I_Role_Access_ID, String trxName) {
		...
		/**
		 * if (I_Role_Access_ID == 0) { setI_Role_Access_ID (0); setProcessed
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Role_Access[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setI_Role_Access_ID(int I_Role_Access_ID) {
		if (I_Role_Access_ID < 1)
			throw new IllegalArgumentException("I_Role_Access_ID is mandatory.");
