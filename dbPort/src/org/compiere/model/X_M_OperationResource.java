...
public class X_M_OperationResource extends PO {
	...
	public X_M_OperationResource(Properties ctx, int M_OperationResource_ID,
			String trxName) {
		super(ctx, M_OperationResource_ID, trxName);
		/**
		 * if (M_OperationResource_ID == 0) { setM_OperationResource_ID (0);
		 * setM_ProductOperation_ID (0); setName (null); setSetupTime
		 * (Env.ZERO); setTeardownTime (Env.ZERO); setUnitRuntime (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_OperationResource[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setM_OperationResource_ID(int M_OperationResource_ID) {
		if (M_OperationResource_ID < 1)
			throw new IllegalArgumentException(
					"M_OperationResource_ID is mandatory.");
		set_ValueNoCheck("M_OperationResource_ID", new Integer(
