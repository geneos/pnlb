 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.375
 */
public class X_I_Inventory extends PO {
	...
	public X_I_Inventory(Properties ctx, int I_Inventory_ID, String trxName) {
		...
		/**
		 * if (I_Inventory_ID == 0) { setI_Inventory_ID (0); setI_IsImported
		 * (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Inventory[").append(get_ID())
				.append("]");
		return sb.toString();
	}
