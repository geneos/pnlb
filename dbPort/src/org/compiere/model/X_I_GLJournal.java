...
public class X_I_GLJournal extends PO {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_GLJournal[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Document Org. Document Organization (independent from account
	 * organization)
	 */
	public void setAD_OrgDoc_ID(int AD_OrgDoc_ID) {
		if (AD_OrgDoc_ID <= 0)
			set_Value("AD_OrgDoc_ID", null);
		else
			set_Value("AD_OrgDoc_ID", new Integer(AD_OrgDoc_ID));
	}

	/**
	 * Get Document Org. Document Organization (independent from account
	 * organization)
	 */
	...
	/**
	 * Set Create New Journal. If selected a new journal within the batch is
	 * created
	 */
	...
	/**
	 * Get Create New Journal. If selected a new journal within the batch is
	 * created
	 */
