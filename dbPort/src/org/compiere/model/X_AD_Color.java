...
public class X_AD_Color extends PO {
	...
	public X_AD_Color(Properties ctx, int AD_Color_ID, String trxName) {
		...
		/**
		 * if (AD_Color_ID == 0) { setAD_Color_ID (0); setAlpha (0); setBlue
		 * (0); setColorType (null); setGreen (0); setImageAlpha (Env.ZERO);
		 * setIsDefault (false); setName (null); setRed (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_Color[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setColorType(Object ColorType) {
		if (ColorType == null)
			throw new IllegalArgumentException("ColorType is mandatory");
		if (ColorType.equals("F") || ColorType.equals("G")
				|| ColorType.equals("L") || ColorType.equals("T"))
			;
		else
			throw new IllegalArgumentException("ColorType Invalid value - "
					+ ColorType + " - Reference_ID=243 - F - G - L - T");
	...
	/**
	 * Set Repeat Distance. Distance in points to repeat gradient color - or
	 * zero
	 */
	...
	/**
	 * Get Repeat Distance. Distance in points to repeat gradient color - or
	 * zero
	 */
