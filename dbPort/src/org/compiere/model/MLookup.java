 ...
 *  </pre>
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MLookup.java,v 1.38 2005/10/26 00:38:15 jjanke Exp $
 */
public final class MLookup extends Lookup implements Serializable
{
	...
	private static final int	MAX_ROWS = 2000;		//	i.e. Drop Down has max 500 items
	/**	Indicator for Null			*/
		...
		public void run()
		{
			...
			try
			{
				...
				while (rs.next())
				{
					...
					/**
					 *	Comentado por Daniel Gini 14/07/2009 - REQ-065
					 *	para que no cargue los inactivos.
					 */
					...
					/**
					 *	Agregado por Daniel Gini 14/07/2009 - REQ-065
					 *	Cargar solo los activos.
					 */
					/*
