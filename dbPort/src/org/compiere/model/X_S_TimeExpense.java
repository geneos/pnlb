...
public class X_S_TimeExpense extends PO {
	...
	public X_S_TimeExpense(Properties ctx, int S_TimeExpense_ID, String trxName) {
		...
		/**
		 * if (S_TimeExpense_ID == 0) { setC_BPartner_ID (0); setDateReport (new
		 * Timestamp(System.currentTimeMillis())); //
		 * 
		 * @#Date@ setDocAction (null); // CO setDocStatus (null); // DR
		 *         setDocumentNo (null); setIsApproved (false);
		 *         setM_PriceList_ID (0); setM_Warehouse_ID (0); setProcessed
		 *         (false); setS_TimeExpense_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_S_TimeExpense[").append(get_ID())
				.append("]");
		return sb.toString();
	}
