...
public class X_M_AttributeValue extends PO {
	...
	public X_M_AttributeValue(Properties ctx, int M_AttributeValue_ID,
		 ...
		 * setM_Attribute_ID (0); setName (null); setValue (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_AttributeValue[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setM_AttributeValue_ID(int M_AttributeValue_ID) {
		if (M_AttributeValue_ID < 1)
			throw new IllegalArgumentException(
					"M_AttributeValue_ID is mandatory.");
		set_ValueNoCheck("M_AttributeValue_ID",
				new Integer(M_AttributeValue_ID));
	}
