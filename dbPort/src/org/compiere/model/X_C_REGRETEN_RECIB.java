 ...
 */
public class X_C_REGRETEN_RECIB extends PO {
	/** Standard Constructor */
	public X_C_REGRETEN_RECIB(Properties ctx, int C_REGRETEN_RECIB_ID,
			String trxName) {
		super(ctx, C_REGRETEN_RECIB_ID, trxName);

	}

	public static String RETEN_IVA = "IVA";

	public static String RETEN_IIBB = "Ingresos Brutos";

	public static String RETEN_GAN = "Ganancias";

	public static String RETEN_SUSS = "SUSS";

	/** Load Constructor */
	public X_C_REGRETEN_RECIB(Properties ctx, ResultSet rs, String trxName) {
		super(ctx, rs, trxName);
	}

	/** TableName=C_REGPERCEP_RECIB */
	public static final String Table_Name = "C_REGRETEN_RECIB";
	...
	/** Set C_REGRETEN_RECIB_ID */
	public void setREGRETEN_RECIB(int regReten) {
		set_Value("C_REGRETEN_RECIB_ID", regReten);
	}

	/** Get C_REGRETEN_RECIB_ID */
	public Integer getREGRETEN_RECIB() {
		return (Integer) get_Value("C_REGRETEN_RECIB_ID");
	}
	...
	/** Set REGIMENSUSS */
	public void setREGIMENSUSS(String REGIMENSUSS) {
		set_Value("REGIMENSUSS", REGIMENSUSS);
	}

	/** Get REGIMENGANANCIAS */
	public String getREGIMENSUSS() {
		String bd = (String) get_Value("REGIMENSUSS");
		if (bd == null)
			return null;
		return bd;
	}
	...
	public String getNAME() {
		String bd = (String) get_Value("Name");
		if (bd == null)
			return "";
		return bd;
	}
