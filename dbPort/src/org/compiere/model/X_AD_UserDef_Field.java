...
public class X_AD_UserDef_Field extends PO {
	...
	public X_AD_UserDef_Field(Properties ctx, int AD_UserDef_Field_ID,
			String trxName) {
		super(ctx, AD_UserDef_Field_ID, trxName);
		/**
		 * if (AD_UserDef_Field_ID == 0) { setAD_Field_ID (0);
		 * setAD_UserDef_Field_ID (0); setAD_UserDef_Tab_ID (0); setDefaultValue
		 * (null); setIsDisplayed (false); setIsReadOnly (false); setIsSameLine
		 * (false); setName (null); setSeqNo (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_UserDef_Field[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setAD_UserDef_Field_ID(int AD_UserDef_Field_ID) {
		if (AD_UserDef_Field_ID < 1)
			throw new IllegalArgumentException(
					"AD_UserDef_Field_ID is mandatory.");
		set_ValueNoCheck("AD_UserDef_Field_ID",
				new Integer(AD_UserDef_Field_ID));
	}
