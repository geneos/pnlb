 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:59.187
 */
public class X_C_Country extends PO {
	...
	public X_C_Country(Properties ctx, int C_Country_ID, String trxName) {
		...
		/**
		 * if (C_Country_ID == 0) { setC_Country_ID (0); setCountryCode (null);
		 * setDisplaySequence (null); //
		 * 
		 * @C@,
		 * @R@
		 * @P@ setHasPostal_Add (false); setHasRegion (false);
		 *     setIsAddressLinesLocalReverse (false); setIsAddressLinesReverse
		 *     (false); setName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_Country[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setExpressionBankAccountNo(String ExpressionBankAccountNo) {
		if (ExpressionBankAccountNo != null
				&& ExpressionBankAccountNo.length() > 20) {
			log.warning("Length > 20 - truncated");
	...
	public void setExpressionBankRoutingNo(String ExpressionBankRoutingNo) {
		if (ExpressionBankRoutingNo != null
				&& ExpressionBankRoutingNo.length() > 20) {
			log.warning("Length > 20 - truncated");
	...
	/**
	 * Set Phone Format. Format of the phone; Can contain fixed format elements,
	...
	/**
	 * Get Phone Format. Format of the phone; Can contain fixed format elements,
	 * Variables: "_lLoOaAcCa09"
	 */
	...
	/**
	 * Set Postal Code Format. Format of the postal code; Can contain fixed
	 * format elements, Variables: "_lLoOaAcCa09"
	 */
	...
	/**
	 * Get Postal Code Format. Format of the postal code; Can contain fixed
	 * format elements, Variables: "_lLoOaAcCa09"
	 */
	...
	/**
	 * Set Additional Postal Format. Format of the value; Can contain fixed
	 * format elements, Variables: "_lLoOaAcCa09"
	 */
	...
	/**
	 * Get Additional Postal Format. Format of the value; Can contain fixed
	 * format elements, Variables: "_lLoOaAcCa09"
	 */
	...
	public void setIsAddressLinesLocalReverse(boolean IsAddressLinesLocalReverse) {
		set_Value("IsAddressLinesLocalReverse", new Boolean(
