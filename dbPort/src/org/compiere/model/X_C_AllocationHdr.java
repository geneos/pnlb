 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.562
 */
public class X_C_AllocationHdr extends PO {
	...
	public X_C_AllocationHdr(Properties ctx, int C_AllocationHdr_ID,
		...
		/**
		 * if (C_AllocationHdr_ID == 0) { setApprovalAmt (Env.ZERO);
		 * setC_AllocationHdr_ID (0); setC_Currency_ID (0); setDateAcct (new
		 * Timestamp(System.currentTimeMillis())); setDateTrx (new
		 * Timestamp(System.currentTimeMillis())); setDocAction (null); // CO
		 * setDocStatus (null); // DR setDocumentNo (null); setIsApproved
		 * (false); setIsManual (false); setPosted (false); setProcessed
		 * (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_AllocationHdr[").append(
				get_ID()).append("]");
		return sb.toString();
	}
