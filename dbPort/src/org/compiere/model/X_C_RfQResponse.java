 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:00.484
 */
public class X_C_RfQResponse extends PO {
	...
	public X_C_RfQResponse(Properties ctx, int C_RfQResponse_ID, String trxName) {
		...
		/**
		 * if (C_RfQResponse_ID == 0) { setC_BPartner_ID (0);
		 * setC_BPartner_Location_ID (0); setC_Currency_ID (0); //
		 * 
		 * @C_Currency_ID@ setC_RfQResponse_ID (0); setC_RfQ_ID (0);
		 *                 setIsComplete (false); setIsSelectedWinner (false);
		 *                 setIsSelfService (false); setName (null); setPrice
		 *                 (Env.ZERO); setProcessed (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_RfQResponse[").append(get_ID())
				.append("]");
		return sb.toString();
	}
