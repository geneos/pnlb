 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.39
 */
public class X_I_Invoice extends PO {
	...
	public X_I_Invoice(Properties ctx, int I_Invoice_ID, String trxName) {
		...
		/**
		 * if (I_Invoice_ID == 0) { setI_Invoice_ID (0); setI_IsImported
		 * (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Invoice[").append(get_ID())
				.append("]");
		return sb.toString();
	}
