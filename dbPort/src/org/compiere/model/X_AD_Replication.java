...
public class X_AD_Replication extends PO {
	...
	public X_AD_Replication(Properties ctx, int AD_Replication_ID,
			String trxName) {
		super(ctx, AD_Replication_ID, trxName);
		/**
		 * if (AD_Replication_ID == 0) { setAD_ReplicationStrategy_ID (0);
		 * setAD_Replication_ID (0); setHostAddress (null); setHostPort (0); //
		 * 80 setIsRMIoverHTTP (true); // Y setName (null); setRemote_Client_ID
		 * (0); setRemote_Org_ID (0); }
		 */
	}
	...
	public void setAD_ReplicationStrategy_ID(int AD_ReplicationStrategy_ID) {
		...
		set_Value("AD_ReplicationStrategy_ID", new Integer(
	...
	/**
	 * Set Remote Client. Remote Client to be used to replicate / synchronize
	 * data with.
	 */
	...
	/**
	 * Get Remote Client. Remote Client to be used to replicate / synchronize
	 * data with.
	 */
	...
	/**
	 * Set Remote Organization. Remote Organization to be used to replicate /
	...
	/**
	 * Get Remote Organization. Remote Organization to be used to replicate /
	 * synchronize data with.
	 */
