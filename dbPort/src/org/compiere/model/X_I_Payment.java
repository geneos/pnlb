 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.484
 */
public class X_I_Payment extends PO {
	...
	public X_I_Payment(Properties ctx, int I_Payment_ID, String trxName) {
		...
		/**
		 * if (I_Payment_ID == 0) { setI_IsImported (false); setI_Payment_ID
		 * (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Payment[").append(get_ID())
				.append("]");
		return sb.toString();
	}
