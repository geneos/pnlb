 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:57.953
 */
public class X_AD_Window_Access extends PO {
	/** Standard Constructor */
	public X_AD_Window_Access(Properties ctx, int AD_Window_Access_ID,
			String trxName) {
		super(ctx, AD_Window_Access_ID, trxName);
		/**
		 * if (AD_Window_Access_ID == 0) { setAD_Role_ID (0); setAD_Window_ID
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_Window_Access[").append(
				get_ID()).append("]");
		return sb.toString();
	}
