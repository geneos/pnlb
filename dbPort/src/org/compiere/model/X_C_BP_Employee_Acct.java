...
public class X_C_BP_Employee_Acct extends PO {
	...
	public X_C_BP_Employee_Acct(Properties ctx, int C_BP_Employee_Acct_ID,
			String trxName) {
		super(ctx, C_BP_Employee_Acct_ID, trxName);
		/**
		 * if (C_BP_Employee_Acct_ID == 0) { setC_AcctSchema_ID (0);
		 * setC_BPartner_ID (0); setE_Expense_Acct (0); setE_Prepayment_Acct
		 * (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_BP_Employee_Acct[").append(
				get_ID()).append("]");
		return sb.toString();
	}
