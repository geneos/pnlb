...
public class X_MPC_MRP extends PO {
	...
	public X_MPC_MRP(Properties ctx, int MPC_MRP_ID, String trxName) {
		...
		/**
		 * if (MPC_MRP_ID == 0) { setDateOrdered (new
		 * Timestamp(System.currentTimeMillis())); setDatePromised (new
		 * Timestamp(System.currentTimeMillis())); setMPC_MRP_ID (0);
		 * setM_Warehouse_ID (0); setValue (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_MPC_MRP[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setMPC_MRP_ID(int MPC_MRP_ID) {
		if (MPC_MRP_ID < 1)
			throw new IllegalArgumentException("MPC_MRP_ID is mandatory.");
