...
/**
 * Generated Model for MPC_ProfileBOMCost
 * 
 * @author Jorg Janke (generated)
 * @version Release 2.5.3b - 2008-04-04 14:06:02.234
 */
public class X_MPC_ProfileBOMCost extends PO {
	/** Standard Constructor */
	public X_MPC_ProfileBOMCost(Properties ctx, int MPC_ProfileBOMCost_ID,
			String trxName) {
		super(ctx, MPC_ProfileBOMCost_ID, trxName);
		/**
		 * if (MPC_ProfileBOMCost_ID == 0) { setMPC_ProfileBOMCost_ID (0);
		 * setMPC_ProfileBOM_ID (0); setM_ProductE_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_MPC_ProfileBOMCost[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setMPC_ProfileBOMCost_ID(int MPC_ProfileBOMCost_ID) {
		if (MPC_ProfileBOMCost_ID < 1)
			throw new IllegalArgumentException(
					"MPC_ProfileBOMCost_ID is mandatory.");
		set_ValueNoCheck("MPC_ProfileBOMCost_ID", new Integer(
				MPC_ProfileBOMCost_ID));
	}
