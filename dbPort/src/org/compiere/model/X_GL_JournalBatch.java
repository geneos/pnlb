 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.156
 */
public class X_GL_JournalBatch extends PO {
	...
	public X_GL_JournalBatch(Properties ctx, int GL_JournalBatch_ID,
		...
		/**
		 * if (GL_JournalBatch_ID == 0) { setC_DocType_ID (0); setDescription
		 * (null); setDocAction (null); // CO setDocStatus (null); // DR
		 * setDocumentNo (null); setGL_JournalBatch_ID (0); setPostingType
		 * (null); // A setProcessed (false); setProcessing (false); setTotalCr
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_GL_JournalBatch[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setGL_JournalBatch_ID(int GL_JournalBatch_ID) {
		if (GL_JournalBatch_ID < 1)
			throw new IllegalArgumentException(
					"GL_JournalBatch_ID is mandatory.");
