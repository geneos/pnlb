...
/**
 * Generated Model for MPC_Schedule
 * 
 * @author Jorg Janke (generated)
 * @version Release 2.5.3b - 2008-04-04 14:06:02.312
 */
public class X_MPC_Schedule extends PO {
	...
	public X_MPC_Schedule(Properties ctx, int MPC_Schedule_ID, String trxName) {
		...
		/**
		 * if (MPC_Schedule_ID == 0) { setAD_OrgTrx_ID (0); setDateFinish (new
		 * Timestamp(System.currentTimeMillis())); //
		 * 
		 * @#Date@ setDateFinishSchedule (new
		 *         Timestamp(System.currentTimeMillis())); //
		 * @#Date@ setDateStart (new Timestamp(System.currentTimeMillis())); //
		 * @#Date@ setDateStartSchedule (new
		 *         Timestamp(System.currentTimeMillis())); //
		 * @#Date@ setIsApproved (false); setIsCreated (false); setIsPrinted
		 *         (false); setIsSOTrx (false); setIsSelected (false);
		 *         setMPC_Schedule_ID (0); setM_Warehouse_ID (0); setName
		 *         (null); setPlanner_ID (0); setProcessed (false); // N
		 *         setS_Resource_ID (0); setScheduleType (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_MPC_Schedule[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setDateFinish(Timestamp DateFinish) {
		if (DateFinish == null)
			throw new IllegalArgumentException("DateFinish is mandatory.");
	...
	public void setDateFinishSchedule(Timestamp DateFinishSchedule) {
		if (DateFinishSchedule == null)
			throw new IllegalArgumentException(
					"DateFinishSchedule is mandatory.");
	...
	public void setDateStartSchedule(Timestamp DateStartSchedule) {
		if (DateStartSchedule == null)
			throw new IllegalArgumentException(
					"DateStartSchedule is mandatory.");
	...
	/**
	 * Set Manufacturing Schedule. ID of a production schedule
	 */
	public void setMPC_Schedule_ID(int MPC_Schedule_ID) {
		if (MPC_Schedule_ID < 1)
			throw new IllegalArgumentException("MPC_Schedule_ID is mandatory.");
		set_ValueNoCheck("MPC_Schedule_ID", new Integer(MPC_Schedule_ID));
	}

	/**
	 * Get Manufacturing Schedule. ID of a production schedule
	 */
	...
	public void setPlanner_ID(int Planner_ID) {
		if (Planner_ID < 1)
			throw new IllegalArgumentException("Planner_ID is mandatory.");
