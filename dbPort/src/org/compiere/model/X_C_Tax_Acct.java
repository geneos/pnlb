...
public class X_C_Tax_Acct extends PO {
	...
	public X_C_Tax_Acct(Properties ctx, int C_Tax_Acct_ID, String trxName) {
		...
		/**
		 * if (C_Tax_Acct_ID == 0) { setC_AcctSchema_ID (0); setC_Tax_ID (0);
		 * setT_Credit_Acct (0); setT_Due_Acct (0); setT_Expense_Acct (0);
		 * setT_Liability_Acct (0); setT_Receivables_Acct (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_Tax_Acct[").append(get_ID())
				.append("]");
		return sb.toString();
	}
