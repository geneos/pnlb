 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:57.703
 */
public class X_AD_WF_ActivityResult extends PO {
	/** Standard Constructor */
	public X_AD_WF_ActivityResult(Properties ctx, int AD_WF_ActivityResult_ID,
			String trxName) {
		super(ctx, AD_WF_ActivityResult_ID, trxName);
		/**
		 * if (AD_WF_ActivityResult_ID == 0) { setAD_WF_ActivityResult_ID (0);
		 * setAD_WF_Activity_ID (0); setAttributeName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_WF_ActivityResult[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setAD_WF_ActivityResult_ID(int AD_WF_ActivityResult_ID) {
		if (AD_WF_ActivityResult_ID < 1)
			throw new IllegalArgumentException(
					"AD_WF_ActivityResult_ID is mandatory.");
		set_ValueNoCheck("AD_WF_ActivityResult_ID", new Integer(
