 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.046
 */
public class X_AD_WorkflowProcessorLog extends PO {
	/** Standard Constructor */
	public X_AD_WorkflowProcessorLog(Properties ctx,
			int AD_WorkflowProcessorLog_ID, String trxName) {
		super(ctx, AD_WorkflowProcessorLog_ID, trxName);
		/**
		 * if (AD_WorkflowProcessorLog_ID == 0) { setAD_WorkflowProcessorLog_ID
		 * (0); setAD_WorkflowProcessor_ID (0); setIsError (false); }
		 */
	}
	...
	/**
	 * Set Workflow Processorl Log. Result of the execution of the Workflow
	 * Processor
	 */
	public void setAD_WorkflowProcessorLog_ID(int AD_WorkflowProcessorLog_ID) {
		if (AD_WorkflowProcessorLog_ID < 1)
			throw new IllegalArgumentException(
					"AD_WorkflowProcessorLog_ID is mandatory.");
		set_ValueNoCheck("AD_WorkflowProcessorLog_ID", new Integer(
				AD_WorkflowProcessorLog_ID));
	}

	/**
	 * Get Workflow Processorl Log. Result of the execution of the Workflow
	 * Processor
	 */
