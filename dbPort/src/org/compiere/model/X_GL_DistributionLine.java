 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.062
 */
public class X_GL_DistributionLine extends PO {
	...
	public X_GL_DistributionLine(Properties ctx, int GL_DistributionLine_ID,
		...
		/**
		 * if (GL_DistributionLine_ID == 0) { setGL_DistributionLine_ID (0);
		 * setGL_Distribution_ID (0); setLine (0); //
		 * 
		 * @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM
		 *             GL_DistributionLine WHERE
		 *             GL_Distribution_ID=@GL_Distribution_ID@ setOverwriteAcct
		 *             (false); setOverwriteActivity (false);
		 *             setOverwriteBPartner (false); setOverwriteCampaign
		 *             (false); setOverwriteLocFrom (false); setOverwriteLocTo
		 *             (false); setOverwriteOrg (false); setOverwriteOrgTrx
		 *             (false); setOverwriteProduct (false); setOverwriteProject
		 *             (false); setOverwriteSalesRegion (false);
		 *             setOverwriteUser1 (false); setOverwriteUser2 (false);
		 *             setPercent (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_GL_DistributionLine[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setGL_DistributionLine_ID(int GL_DistributionLine_ID) {
		if (GL_DistributionLine_ID < 1)
			throw new IllegalArgumentException(
					"GL_DistributionLine_ID is mandatory.");
		set_ValueNoCheck("GL_DistributionLine_ID", new Integer(
	...
	public void setGL_Distribution_ID(int GL_Distribution_ID) {
		if (GL_Distribution_ID < 1)
			throw new IllegalArgumentException(
					"GL_Distribution_ID is mandatory.");
	...
	/**
	 * Set Overwrite Account. Overwrite the account segment Account with the
	 * value specified
	 */
	...
	/**
	 * Get Overwrite Account. Overwrite the account segment Account with the
	 * value specified
	 */
	...
	/**
	 * Set Overwrite Activity. Overwrite the account segment Activity with the
	 * value specified
	 */
	...
	/**
	 * Get Overwrite Activity. Overwrite the account segment Activity with the
	 * value specified
	 */
	...
	/**
	 * Set Overwrite Bus.Partner. Overwrite the account segment Business Partner
	...
	/**
	 * Get Overwrite Bus.Partner. Overwrite the account segment Business Partner
	 * with the value specified
	 */
	...
	/**
	 * Set Overwrite Campaign. Overwrite the account segment Campaign with the
	 * value specified
	 */
	...
	/**
	 * Get Overwrite Campaign. Overwrite the account segment Campaign with the
	 * value specified
	 */
	...
	/**
	 * Set Overwrite Location From. Overwrite the account segment Location From
	 * with the value specified
	 */
	...
	/**
	 * Get Overwrite Location From. Overwrite the account segment Location From
	 * with the value specified
	 */
	...
	/**
	 * Set Overwrite Location To. Overwrite the account segment Location From
	 * with the value specified
	 */
	...
	/**
	 * Get Overwrite Location To. Overwrite the account segment Location From
	 * with the value specified
	 */
	...
	/**
	 * Set Overwrite Organization. Overwrite the account segment Organization
	 * with the value specified
	 */
	...
	/**
	 * Get Overwrite Organization. Overwrite the account segment Organization
	 * with the value specified
	 */
	 ...
	 * Organization with the value specified
	 */
	...
	/**
	 * Get Overwrite Trx Organuzation. Overwrite the account segment Transaction
	 * Organization with the value specified
	 */
	...
	/**
	 * Set Overwrite Product. Overwrite the account segment Product with the
	 * value specified
	 */
	...
	/**
	 * Get Overwrite Product. Overwrite the account segment Product with the
	 * value specified
	 */
	...
	/**
	 * Set Overwrite Project. Overwrite the account segment Project with the
	 * value specified
	 */
	...
	/**
	 * Get Overwrite Project. Overwrite the account segment Project with the
	 * value specified
	 */
	...
	/**
	 * Set Overwrite Sales Region. Overwrite the account segment Sales Region
	 * with the value specified
	 */
	...
	/**
	 * Get Overwrite Sales Region. Overwrite the account segment Sales Region
	 * with the value specified
	 */
	...
	/**
	 * Set Overwrite User1. Overwrite the account segment User 1 with the value
	 * specified
	 */
	...
	/**
	 * Get Overwrite User1. Overwrite the account segment User 1 with the value
	 * specified
	 */
	...
	/**
	 * Set Overwrite User2. Overwrite the account segment User 2 with the value
	 * specified
	 */
	...
	/**
	 * Get Overwrite User2. Overwrite the account segment User 2 with the value
	 * specified
	 */
