 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:03.484
 */
public class X_M_Product_Costing extends PO {
	/** Standard Constructor */
	public X_M_Product_Costing(Properties ctx, int M_Product_Costing_ID,
			String trxName) {
		super(ctx, M_Product_Costing_ID, trxName);
		/**
		 * if (M_Product_Costing_ID == 0) { setC_AcctSchema_ID (0);
		 * setCostAverage (Env.ZERO); setCostAverageCumAmt (Env.ZERO);
		 * setCostAverageCumQty (Env.ZERO); setCostStandard (Env.ZERO);
		 * setCostStandardCumAmt (Env.ZERO); setCostStandardCumQty (Env.ZERO);
		 * setCostStandardPOAmt (Env.ZERO); setCostStandardPOQty (Env.ZERO);
		 * setCurrentCostPrice (Env.ZERO); setFutureCostPrice (Env.ZERO);
		 * setM_Product_ID (0); setPriceLastInv (Env.ZERO); setPriceLastPO
		 * (Env.ZERO); setTotalInvAmt (Env.ZERO); setTotalInvQty (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_Product_Costing[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setCostAverageCumAmt(BigDecimal CostAverageCumAmt) {
		if (CostAverageCumAmt == null)
			throw new IllegalArgumentException(
					"CostAverageCumAmt is mandatory.");
	...
	public void setCostAverageCumQty(BigDecimal CostAverageCumQty) {
		if (CostAverageCumQty == null)
			throw new IllegalArgumentException(
					"CostAverageCumQty is mandatory.");
		set_ValueNoCheck("CostAverageCumQty", CostAverageCumQty);
	}

	/**
	 * Get Average Cost Quantity Sum. Cumulative average cost quantities
	 * (internal)
	 */
	...
	public void setCostStandardCumAmt(BigDecimal CostStandardCumAmt) {
		if (CostStandardCumAmt == null)
			throw new IllegalArgumentException(
					"CostStandardCumAmt is mandatory.");
	...
	public void setCostStandardCumQty(BigDecimal CostStandardCumQty) {
		if (CostStandardCumQty == null)
			throw new IllegalArgumentException(
					"CostStandardCumQty is mandatory.");
	...
	/**
	 * Set Std PO Cost Amount Sum. Standard Cost Purchase Order Amount Sum
	 * (internal)
	 */
	public void setCostStandardPOAmt(BigDecimal CostStandardPOAmt) {
		if (CostStandardPOAmt == null)
			throw new IllegalArgumentException(
					"CostStandardPOAmt is mandatory.");
		set_ValueNoCheck("CostStandardPOAmt", CostStandardPOAmt);
	}

	/**
	 * Get Std PO Cost Amount Sum. Standard Cost Purchase Order Amount Sum
	 * (internal)
	 */
	...
	/**
	 * Set Std PO Cost Quantity Sum. Standard Cost Purchase Order Quantity Sum
	 * (internal)
	 */
	public void setCostStandardPOQty(BigDecimal CostStandardPOQty) {
		if (CostStandardPOQty == null)
			throw new IllegalArgumentException(
					"CostStandardPOQty is mandatory.");
		set_ValueNoCheck("CostStandardPOQty", CostStandardPOQty);
	}

	/**
	 * Get Std PO Cost Quantity Sum. Standard Cost Purchase Order Quantity Sum
	 * (internal)
	 */
