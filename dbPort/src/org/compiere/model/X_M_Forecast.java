...
public class X_M_Forecast extends PO {
	...
	public X_M_Forecast(Properties ctx, int M_Forecast_ID, String trxName) {
		...
		/**
		 * if (M_Forecast_ID == 0) { setC_Calendar_ID (0); setC_Year_ID (0);
		 * setIsDefault (false); setM_Forecast_ID (0); setName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_Forecast[").append(get_ID())
				.append("]");
		return sb.toString();
	}
