...
public class X_C_Recurring_Run extends PO {
	...
	public X_C_Recurring_Run(Properties ctx, int C_Recurring_Run_ID,
			String trxName) {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_Recurring_Run[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setC_Recurring_Run_ID(int C_Recurring_Run_ID) {
		if (C_Recurring_Run_ID < 1)
			throw new IllegalArgumentException(
					"C_Recurring_Run_ID is mandatory.");
