...
public class X_C_BankAccount_Acct extends PO {
	...
	public X_C_BankAccount_Acct(Properties ctx, int C_BankAccount_Acct_ID,
			String trxName) {
		 ...
		 * setC_AcctSchema_ID (0); setC_BankAccount_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_BankAccount_Acct[").append(
				get_ID()).append("]");
		return sb.toString();
	}
