 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.265
 */
public class X_I_Conversion_Rate extends PO {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Conversion_Rate[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setC_Conversion_Rate_ID(int C_Conversion_Rate_ID) {
		if (C_Conversion_Rate_ID <= 0)
			set_Value("C_Conversion_Rate_ID", null);
		else
	...
	/**
	 * Set Create Reciprocal Rate. Create Reciprocal Rate from current
	 * information
	 */
	...
	/**
	 * Get Create Reciprocal Rate. Create Reciprocal Rate from current
	 * information
	 */
	...
	public void setI_Conversion_Rate_ID(int I_Conversion_Rate_ID) {
		if (I_Conversion_Rate_ID < 1)
			throw new IllegalArgumentException(
					"I_Conversion_Rate_ID is mandatory.");
		set_ValueNoCheck("I_Conversion_Rate_ID", new Integer(
	...
	public KeyNamePair getKeyNamePair() {
		return new KeyNamePair(get_ID(), String
				.valueOf(getI_Conversion_Rate_ID()));
	}
