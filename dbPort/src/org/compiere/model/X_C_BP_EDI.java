 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.64
 */
public class X_C_BP_EDI extends PO {
	...
	public X_C_BP_EDI(Properties ctx, int C_BP_EDI_ID, String trxName) {
		...
		/**
		 * if (C_BP_EDI_ID == 0) { setAD_Sequence_ID (0); setC_BP_EDI_ID (0);
		 * setC_BPartner_ID (0); setCustomerNo (null); setEDIType (null);
		 * setEMail_Error_To (null); setEMail_Info_To (null); setIsAudited
		 * (false); setIsInfoSent (false); setM_Warehouse_ID (0); setName
		 * (null); setReceiveInquiryReply (false); setReceiveOrderReply (false);
		 * setSendInquiry (false); setSendOrder (false); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_BP_EDI[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setEDIType(String EDIType) {
		if (EDIType == null)
			throw new IllegalArgumentException("EDIType is mandatory");
		if (EDIType.equals("E") || EDIType.equals("M") || EDIType.equals("X"))
			;
		else
			throw new IllegalArgumentException("EDIType Invalid value - "
					+ EDIType + " - Reference_ID=201 - E - M - X");
		if (EDIType.length() > 1) {
	...
	/**
	 * Set From EMail. Full EMail address used to send requests - e.g.
	 * edi@organization.com
	 */
	...
	/**
	 * Get From EMail. Full EMail address used to send requests - e.g.
	 * edi@organization.com
	 */
	...
	/**
	 * Set From EMail User ID. User ID of the sending EMail address (on default
	 * SMTP Host) - e.g. edi
	 */
	...
	/**
	 * Get From EMail User ID. User ID of the sending EMail address (on default
	 * SMTP Host) - e.g. edi
	 */
	...
	/**
	 * Set To EMail. EMail address to send requests to - e.g.
	 * edi@manufacturer.com
	 */
	...
	/**
	 * Get To EMail. EMail address to send requests to - e.g.
	 * edi@manufacturer.com
	 */
