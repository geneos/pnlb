 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:04.343
 */
public class X_RV_WarehousePrice extends PO {
	/** Standard Constructor */
	public X_RV_WarehousePrice(Properties ctx, int RV_WarehousePrice_ID,
			String trxName) {
		super(ctx, RV_WarehousePrice_ID, trxName);
		/**
		 * if (RV_WarehousePrice_ID == 0) { setC_UOM_ID (0);
		 * setM_PriceList_Version_ID (0); setM_Product_ID (0); setM_Warehouse_ID
		 * (0); setName (null); setValue (null); setWarehouseName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_RV_WarehousePrice[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setIsInstanceAttribute(boolean IsInstanceAttribute) {
		set_ValueNoCheck("IsInstanceAttribute",
				new Boolean(IsInstanceAttribute));
	}
