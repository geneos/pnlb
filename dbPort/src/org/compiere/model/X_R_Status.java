 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:04.703
 */
public class X_R_Status extends PO {
	...
	public X_R_Status(Properties ctx, int R_Status_ID, String trxName) {
		...
		/**
		 * if (R_Status_ID == 0) { setIsClosed (false); // N setIsDefault
		 * (false); setIsFinalClose (false); // N setIsOpen (false);
		 * setIsWebCanUpdate (false); setName (null); setR_Status_ID (0);
		 * setValue (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_R_Status[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setUpdate_Status_ID(int Update_Status_ID) {
		if (Update_Status_ID <= 0)
			set_Value("Update_Status_ID", null);
		else
