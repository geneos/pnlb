...
public class X_C_BankStatementLoader extends PO {
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_BankStatementLoader[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Bank Statement Loader. Definition of Bank Statement Loader (SWIFT,
	 * OFX)
	 */
	public void setC_BankStatementLoader_ID(int C_BankStatementLoader_ID) {
		if (C_BankStatementLoader_ID < 1)
			throw new IllegalArgumentException(
					"C_BankStatementLoader_ID is mandatory.");
		set_ValueNoCheck("C_BankStatementLoader_ID", new Integer(
				C_BankStatementLoader_ID));
	}

	/**
	 * Get Bank Statement Loader. Definition of Bank Statement Loader (SWIFT,
	 * OFX)
	 */
	...
	public void setFinancialInstitutionID(String FinancialInstitutionID) {
		if (FinancialInstitutionID != null
				&& FinancialInstitutionID.length() > 20) {
			log.warning("Length > 20 - truncated");
