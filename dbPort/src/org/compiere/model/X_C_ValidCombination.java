 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:00.828
 */
public class X_C_ValidCombination extends PO {
	...
	public X_C_ValidCombination(Properties ctx, int C_ValidCombination_ID,
		 ...
		 * setC_AcctSchema_ID (0); setC_ValidCombination_ID (0);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_ValidCombination[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Alias. Defines an alternate method of indicating an account
	 * combination.
	 */
	...
	/**
	 * Get Alias. Defines an alternate method of indicating an account
	 * combination.
	 */
	...
	public void setC_ValidCombination_ID(int C_ValidCombination_ID) {
		if (C_ValidCombination_ID < 1)
			throw new IllegalArgumentException(
					"C_ValidCombination_ID is mandatory.");
		set_ValueNoCheck("C_ValidCombination_ID", new Integer(
