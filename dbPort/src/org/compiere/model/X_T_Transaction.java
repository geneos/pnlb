 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:05.265
 */
public class X_T_Transaction extends PO {
	...
	public X_T_Transaction(Properties ctx, int T_Transaction_ID, String trxName) {
		...
		/**
		 * if (T_Transaction_ID == 0) { setAD_PInstance_ID (0);
		 * setM_AttributeSetInstance_ID (0); setM_Locator_ID (0);
		 * setM_Product_ID (0); setM_Transaction_ID (0); setMovementDate (new
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_T_Transaction[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public void setM_Production_ID(int M_Production_ID) {
		if (M_Production_ID <= 0)
			set_Value("M_Production_ID", null);
		else
	...
	public void setSearch_InOut_ID(int Search_InOut_ID) {
		if (Search_InOut_ID <= 0)
			set_Value("Search_InOut_ID", null);
		else
	...
	public void setSearch_Invoice_ID(int Search_Invoice_ID) {
		if (Search_Invoice_ID <= 0)
			set_Value("Search_Invoice_ID", null);
		else
	...
	public void setSearch_Order_ID(int Search_Order_ID) {
		if (Search_Order_ID <= 0)
			set_Value("Search_Order_ID", null);
		else
