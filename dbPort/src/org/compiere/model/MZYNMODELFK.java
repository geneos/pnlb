...
public class MZYNMODELFK extends X_ZYN_MODEL_FK {
    ...
    protected boolean beforeSave(boolean newRecord) {
        ...
        if (column1.getAD_Reference_ID() == column2.getAD_Reference_ID()) {
            return true;
        } else if ((column1.getAD_Reference_ID() == 13 || column1.getAD_Reference_ID() == 18 
                        || column1.getAD_Reference_ID() == 19 || column1.getAD_Reference_ID() == 30 
                        || column1.getAD_Reference_ID() == 35 || column1.getAD_Reference_ID() == 17
                        || column1.getAD_Reference_ID() == 25) 
                     && (column2.getAD_Reference_ID() == 13 || column2.getAD_Reference_ID() == 18 
                        || column2.getAD_Reference_ID() == 19 || column2.getAD_Reference_ID() == 30 
                        || column2.getAD_Reference_ID() == 35 || column2.getAD_Reference_ID() == 17 
                        || column1.getAD_Reference_ID() == 25) || column2.getAD_Reference_ID() == 10 ) {
            return true;
        }
        
        JOptionPane.showMessageDialog(null, "Los tipos de datos de las columnas no coinciden.", "Error", JOptionPane.ERROR_MESSAGE);
        return false;
