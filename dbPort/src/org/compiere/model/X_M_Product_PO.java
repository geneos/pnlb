 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:03.5
 */
public class X_M_Product_PO extends PO {
	...
	public X_M_Product_PO(Properties ctx, int M_Product_PO_ID, String trxName) {
		...
		/**
		 * if (M_Product_PO_ID == 0) { setC_BPartner_ID (0); // 0
		 * setIsCurrentVendor (true); // Y setM_Product_ID (0); //
		 * 
		 * @M_Product_ID@ setVendorProductNo (null); //
		 * @Value@ }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_Product_PO[").append(get_ID())
				.append("]");
		return sb.toString();
	}
