 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:01.421
 */
public class X_I_Order extends PO {
	...
	public X_I_Order(Properties ctx, int I_Order_ID, String trxName) {
		...
		/**
		 * if (I_Order_ID == 0) { setI_IsImported (false); setI_Order_ID (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_I_Order[").append(get_ID())
				.append("]");
		return sb.toString();
	}
	...
	public int getI_Order_ID() {
		Integer ii = (Integer) get_Value("I_Order_ID");
		if (ii == null)
			return 0;
		return ii.intValue();
	}
