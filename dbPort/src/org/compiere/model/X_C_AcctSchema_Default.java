 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:58.468
 */
public class X_C_AcctSchema_Default extends PO {
	...
	public X_C_AcctSchema_Default(Properties ctx, int C_AcctSchema_Default_ID,
		 ...
		 * setB_Expense_Acct (0); setB_InTransit_Acct (0); setB_InterestExp_Acct
		 * (0); setB_InterestRev_Acct (0); setB_PaymentSelect_Acct (0);
		 * setB_RevaluationGain_Acct (0); setB_RevaluationLoss_Acct (0);
		 * setB_SettlementGain_Acct (0); setB_SettlementLoss_Acct (0);
		 * setB_UnallocatedCash_Acct (0); setB_Unidentified_Acct (0);
		 * setCB_Asset_Acct (0); setCB_CashTransfer_Acct (0);
		 * setCB_Differences_Acct (0); setCB_Expense_Acct (0);
		 * setCB_Receipt_Acct (0); setC_AcctSchema_ID (0); setC_Prepayment_Acct
		 * (0); setC_Receivable_Acct (0); setC_Receivable_Services_Acct (0);
		 * setCh_Expense_Acct (0); setCh_Revenue_Acct (0); setE_Expense_Acct
		 * (0); setE_Prepayment_Acct (0); setNotInvoicedReceipts_Acct (0);
		 * setNotInvoicedReceivables_Acct (0); setNotInvoicedRevenue_Acct (0);
		 * setPJ_Asset_Acct (0); setPJ_WIP_Acct (0); setP_Asset_Acct (0);
		 * setP_COGS_Acct (0); setP_CostAdjustment_Acct (0); setP_Expense_Acct
		 * (0); setP_InventoryClearing_Acct (0); setP_InvoicePriceVariance_Acct
		 * (0); setP_PurchasePriceVariance_Acct (0); setP_Revenue_Acct (0);
		 * setP_TradeDiscountGrant_Acct (0); setP_TradeDiscountRec_Acct (0);
		 * setPayDiscount_Exp_Acct (0); setPayDiscount_Rev_Acct (0);
		 * setRealizedGain_Acct (0); setRealizedLoss_Acct (0); setT_Credit_Acct
		 * (0); setT_Due_Acct (0); setT_Expense_Acct (0); setT_Liability_Acct
		 * (0); setT_Receivables_Acct (0); setUnEarnedRevenue_Acct (0);
		 * setUnrealizedGain_Acct (0); setUnrealizedLoss_Acct (0);
		 * setV_Liability_Acct (0); setV_Liability_Services_Acct (0);
		 * setV_Prepayment_Acct (0); setW_Differences_Acct (0);
		 * setW_InvActualAdjust_Acct (0); setW_Inventory_Acct (0);
		 * setW_Revaluation_Acct (0); setWithholding_Acct (0); setWriteOff_Acct
		 * (0); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_AcctSchema_Default[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	/**
	 * Set Bank Expense. Bank Expense Account
	 */
	...
	/**
	 * Get Bank Expense. Bank Expense Account
	 */
	...
	/**
	 * Set Bank Revaluation Gain. Bank Revaluation Gain Account
	 */
	...
	/**
	 * Get Bank Revaluation Gain. Bank Revaluation Gain Account
	 */
	...
	/**
	 * Set Bank Revaluation Loss. Bank Revaluation Loss Account
	 */
	...
	/**
	 * Get Bank Revaluation Loss. Bank Revaluation Loss Account
	 */
	...
	/**
	 * Set Bank Settlement Gain. Bank Settlement Gain Account
	 */
	...
	/**
	 * Get Bank Settlement Gain. Bank Settlement Gain Account
	 */
	...
	/**
	 * Set Bank Settlement Loss. Bank Settlement Loss Account
	 */
	...
	/**
	 * Get Bank Settlement Loss. Bank Settlement Loss Account
	 */
	...
	/**
	 * Set Bank Unidentified Receipts. Bank Unidentified Receipts Account
	 */
	...
	/**
	 * Get Bank Unidentified Receipts. Bank Unidentified Receipts Account
	 */
	...
	/**
	 * Set Tax Liability. Account for Tax declaration liability
	 */
	...
	/**
	 * Get Tax Liability. Account for Tax declaration liability
	 */
	...
	/**
	 * Set Tax Receivables. Account for Tax credit after tax declaration
	 */
	...
	/**
	 * Get Tax Receivables. Account for Tax credit after tax declaration
	 */
