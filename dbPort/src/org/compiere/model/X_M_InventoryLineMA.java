...
public class X_M_InventoryLineMA extends PO {
	...
	public X_M_InventoryLineMA(Properties ctx, int M_InventoryLineMA_ID,
		...
		/**
		 * if (M_InventoryLineMA_ID == 0) { setM_AttributeSetInstance_ID (0);
		 * setM_InventoryLine_ID (0); setMovementQty (Env.ZERO); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_M_InventoryLineMA[").append(
				get_ID()).append("]");
		return sb.toString();
	}
