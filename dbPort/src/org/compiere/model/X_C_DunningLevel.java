 ...
 * @version Release 2.5.3b - 2008-04-04 14:05:59.343
 */
public class X_C_DunningLevel extends PO {
	/** Standard Constructor */
	public X_C_DunningLevel(Properties ctx, int C_DunningLevel_ID,
			String trxName) {
		super(ctx, C_DunningLevel_ID, trxName);
		/**
		 * if (C_DunningLevel_ID == 0) { setC_DunningLevel_ID (0);
		 * setC_Dunning_ID (0); setChargeFee (false); setChargeInterest (false);
		 * setDaysAfterDue (Env.ZERO); setDaysBetweenDunning (0); setName
		 * (null); setPrintName (null); }
		 */
	}
	...
	/**
	 * Set Charge Interest. Indicates if interest will be charged on overdue
	 * invoices
	 */
	...
	/**
	 * Get Charge Interest. Indicates if interest will be charged on overdue
	 * invoices
	 */
	...
	/**
	 * Set Days after due date. Days after due date to dun (if negative days
	 * until due)
	 */
	...
	/**
	 * Get Days after due date. Days after due date to dun (if negative days
	 * until due)
	 */
	...
	public void setDunning_PrintFormat_ID(int Dunning_PrintFormat_ID) {
		if (Dunning_PrintFormat_ID <= 0)
			set_Value("Dunning_PrintFormat_ID", null);
		else
			set_Value("Dunning_PrintFormat_ID", new Integer(
	...
	/**
	 * Set Interest in percent. Percentage interest to charge on overdue
	 * invoices
	 */
	...
	/**
	 * Get Interest in percent. Percentage interest to charge on overdue
	 * invoices
	 */
