...
public class X_AD_Attribute extends PO {
	...
	public X_AD_Attribute(Properties ctx, int AD_Attribute_ID, String trxName) {
		...
		/**
		 * if (AD_Attribute_ID == 0) { setAD_Attribute_ID (0);
		 * setAD_Reference_ID (0); setAD_Table_ID (0); setIsEncrypted (false);
		 * setIsFieldOnly (false); setIsHeading (false); setIsMandatory (false);
		 * setIsReadOnly (false); setIsSameLine (false); setIsUpdateable
		 * (false); setName (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_AD_Attribute[").append(get_ID())
				.append("]");
		return sb.toString();
	}
