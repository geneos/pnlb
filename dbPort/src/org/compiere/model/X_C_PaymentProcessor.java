 ...
 * @version Release 2.5.3b - 2008-04-04 14:06:00.14
 */
public class X_C_PaymentProcessor extends PO {
	...
	public X_C_PaymentProcessor(Properties ctx, int C_PaymentProcessor_ID,
		...
		/**
		 * if (C_PaymentProcessor_ID == 0) { setAcceptAMEX (false); setAcceptATM
		 * (false); setAcceptCheck (false); setAcceptCorporate (false);
		 * setAcceptDiners (false); setAcceptDirectDebit (false);
		 * setAcceptDirectDeposit (false); setAcceptDiscover (false);
		 * setAcceptMC (false); setAcceptVisa (false); setC_BankAccount_ID (0);
		 * setC_PaymentProcessor_ID (0); setCommission (Env.ZERO); setCostPerTrx
		 * (Env.ZERO); setHostAddress (null); setHostPort (0); setName (null);
		 * setPassword (null); setRequireVV (false); setUserID (null); }
		 */
	}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("X_C_PaymentProcessor[").append(
				get_ID()).append("]");
		return sb.toString();
	}
	...
	public void setC_PaymentProcessor_ID(int C_PaymentProcessor_ID) {
		...
		set_ValueNoCheck("C_PaymentProcessor_ID", new Integer(
	...
	/**
	 * Set Require CreditCard Verification Code. Require 3/4 digit Credit
	 * Verification Code
	 */
	...
	/**
	 * Get Require CreditCard Verification Code. Require 3/4 digit Credit
	 * Verification Code
	 */
