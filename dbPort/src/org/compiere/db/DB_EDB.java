 ...
 *  EDB Database Port
 *
 *  @author      @author     Jorg Janke, Victor Pèrez 
 *  @version    $Id: DB_EDB.java,v 1.23 2005/03/11 20:29:01 jjanke Exp $
 */
public class DB_EDB implements CompiereDatabase
{
	/**
	 *  EDBL Database
	 */
	...
	/** Driver                  */
	private com.edb.Driver   s_driver = null;

	/** Default Port            */
	public static final int         DEFAULT_PORT = 5432;
	
	/** Data Source				*/
	private com.edb.ds.PGPoolingDataSource m_ds = null;

	/** Statement Converter     */
	private Convert         m_convert = new Convert(Database.DB_EDB);
	/** Connection String       */
	private String          m_connection;
	/** Cached Database Name	*/
	private String			m_dbName = null;
	/**	Logger			*/
	private static CLogger			log	= CLogger.getCLogger (DB_EDB.class);
	...
	{
		//  jdbc:edb://hostname:portnumber/databasename?encoding=UNICODE
	...
	{
		StringBuffer sb = new StringBuffer("DB_EDB[");
	...
	public String convertStatement (String oraStatement)
	{
		...
		{	
			log.log(Level.SEVERE,("DB_EDB.convertStatement - Not Converted (" + oraStatement + ") - "
					+ m_convert.getConversionError()));
			throw new IllegalArgumentException
				("DB_EDBL.convertStatement - Not Converted (" + oraStatement + ") - "
					+ m_convert.getConversionError());
		}
		...
		if (retValue.length != 1)
			//begin vpj-cd 24/06/2005 e-evolution
			{
			log.log(Level.SEVERE, ("DB_EDB.convertStatement - Convert Command Number=" + retValue.length
				+ " (" + oraStatement + ") - " + m_convert.getConversionError()));
			throw new IllegalArgumentException
				("DB_EDB.convertStatement - Convert Command Number=" + retValue.length
					+ " (" + oraStatement + ") - " + m_convert.getConversionError());
			}
			//end vpj-cd 24/06/2005 e-evolution
		...
		if (!oraStatement.equals(retValue[0]) && retValue[0].indexOf("AD_Error") == -1)
			//begin vpj-cd 24/06/2005 e-evolution
			//System.out.println("EDB =>" + retValue[0] + "<= <" + oraStatement + ">");
			log.log(Level.INFO, "EDB =>" + retValue[0] + "<= <" + oraStatement + ">");
		    //end vpj-cd 24/06/2005 e-evolution
		//
		return retValue[0];
	}   //  convertStatement
	...
	{
		throw new UnsupportedOperationException("EDB does not support RowSets");
	}	//	getRowSet
	...
	public DataSource getDataSource(CConnection connection)
	{
		...
		//com.edb.ds.PGPoolingDataSource ds = new org.edb.ds.PGPoolingDataSource();
		com.edb.jdbc3.Jdbc3PoolingDataSource ds = new com.edb.jdbc3.Jdbc3PoolingDataSource();
	...
	{
		DB_EDB edb = new DB_EDB();
		//
		String databaseName = "compiere";
		String uid = "compiere";
		String pwd = "compiere";
		String jdbcURL = edb.getConnectionURL("vpj", DEFAULT_PORT, databaseName, uid);
