 ...
 */
public class ConfigSybase extends Config
{
	 ...
	 *	@param data
	 */
	public ConfigSybase (ConfigurationData data)
	{
		super (data);
	}	//	ConfigSybase
	...
	/**	Sybase DB Info			*/
	private DB_Sybase			p_db = new DB_Sybase();
	...
	public void init()
	{
		p_data.setDatabasePort(String.valueOf(DB_Sybase.DEFAULT_PORT));
	}	//	init
