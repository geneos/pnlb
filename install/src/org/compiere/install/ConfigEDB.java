 ...
 *  @version $Id: ConfigEDB.java,v 1.0 2005/01/31 06:08:15 vpj-cd Exp $
 */
public class ConfigEDB extends Config
{
	 ...
	 *	@param data
	 */
	public ConfigEDB (ConfigurationData data)
	{
		super (data);
	}	//	ConfigSybase
	...
	/**	Sybase DB Info			*/
	private DB_EDB			p_db = new DB_EDB();
	...
	public void init()
	{
		p_data.setDatabasePort(String.valueOf(DB_EDB.DEFAULT_PORT));
	}	//	init
