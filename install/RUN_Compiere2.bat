...
@Set CLASSPATH=lib\Compiere.jar;lib\CompiereCLib.jar;lib\Kompiere.jar;%CLASSPATH%
...
@Set CLASSPATH=%COMPIERE_HOME%\lib\Compiere.jar;%COMPIERE_HOME%\lib\CompiereCLib.jar;;%COMPIERE_HOME%\lib\Kompiere.jar;%CLASSPATH%
@Rem end vpj-cd e-evolution 03/30/2005 CMPCS
...
:START
@"%JAVA%" -Xms32m -Xmx512m -DCOMPIERE_HOME=%COMPIERE_HOME% %PROP% %SECURE% -classpath %CLASSPATH% org.compiere.Compiere >log.txt
