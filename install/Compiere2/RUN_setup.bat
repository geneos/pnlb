...
@Echo =======================================
@SET CP=lib\CInstall.jar;lib\Compiere.jar;lib\CCTools.jar;lib\oracle.jar;lib\sybase.jar;lib\jboss.jar;

@Rem begin vpj-cd e-evolution PostgreSQL & Kompiere
@Rem SET CP=lib\CInstall.jar;lib\Compiere.jar;lib\CCTools.jar;lib\oracle.jar;lib\sybase.jar;lib\jboss.jar;
@SET CP=lib\CInstall.jar;lib\Compiere.jar;lib\CCTools.jar;lib\oracle.jar;lib\sybase.jar;lib\jboss.jar;lib\postgresql.jar;lib\edb.jar;
@Rem end vpj-cd e-evolution PostgreSQL & Kompiere
