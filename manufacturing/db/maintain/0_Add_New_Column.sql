 ...
 *************************************************************************
 * $Id: 0_Add_New_Column.sql,v 1.1 2004/02/03 00:02:27 sklakken Exp $
 ***
...
BEGIN
	...
	DECLARE
        v_EntityType    CHAR(1) := 'A';     -- change to User (also below!)
		NextNo		NUMBER;
		CURSOR Cur_Table	IS
			SELECT	Table_Name 
			FROM	User_Tables ut
