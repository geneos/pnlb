...
@Rem	
@Rem	
@Rem 	$Header: /cvsroot/compiere/utils_dev/myDevEnvTemplate.bat,v 1.19 2005/09/10 01:51:13 jjanke Exp $
...
@SET COMPIERE_SOURCE=C:\Trabajo\Panalab\Compiere2\codigo\compiere\branch\etapa2
...
@SET COMPIERE_ROOT=C:\desarrollo\branch\
...
@SET COMPIERE_INSTALL=C:\desarrollo\branch\Install
...
@SET COMPIERE_VERSION_FILE=C252
