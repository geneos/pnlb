...
public class DesktopEntity extends JInternalFrame implements TaskSource
{
	...
	{	
		...
		org.compiere.model.M_Table table = org.compiere.model.M_Table.get(org.compiere.util.Env.getCtx(),querytoken.getName());
		this.getJMenuBar().add(header = new JMenu(org.compiere.util.Msg.getMsg(Env.getCtx(), table.getName())+ " [" + querytoken.getName() + "]" ));
	...
	{
		//begin vpj-cd e-evolution 05/16/2005 
		org.compiere.model.M_Element element = org.compiere.model.M_Element.get(org.compiere.util.Env.getCtx(),label);
		//end vpj-cd e-evolution 05/16/2005
		for(int i=0; i<fields.getComponentCount(); i++)
		{
			...
			if(field.getText().equals(org.compiere.util.Msg.getMsg(Env.getCtx(),element.getName()))) return i;
			//end vpj-cd e-evolution 05/16/2005
		}
...
//	/////////////////////////////////////////////////////////////////////////////
	...
	private class References extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			new DialogReferences(DesktopEntity.this).show();
		}
	}
	...
	private class Preview extends AbstractAction implements Runnable
	{
		...
		public void run()
		{
			...
			new DialogCount(DesktopEntity.this.getHeader(), DesktopEntity.this).show();
			
			if(continueWithPreview) new QueryPreview(DesktopEntity.this.getHeader(),DesktopEntity.this).show();
		}
