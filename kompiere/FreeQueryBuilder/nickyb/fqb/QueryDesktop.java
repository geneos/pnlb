...
public class QueryDesktop extends JDesktopPane
{
	...
	DesktopEntity find(QueryTokens.Table table)
	{
		...
		for(int i=0; i<allFrames.length; i++)
		{
			...
			org.compiere.model.M_Table t = org.compiere.model.M_Table.get(org.compiere.util.Env.getCtx(),table.getName());
			String alias = org.compiere.util.Msg.getMsg(Env.getCtx(), t.getName())+ " [" + table.getName() + "]" ;
