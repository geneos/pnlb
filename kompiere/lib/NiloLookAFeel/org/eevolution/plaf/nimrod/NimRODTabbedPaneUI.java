...
public class NimRODTabbedPaneUI extends BasicTabbedPaneUI {
  ...
  protected void paintTabBackground( Graphics g, int tabPlacement,
    ...
    switch( tabPlacement ) {
      case LEFT:
        ...
        gradientShadow = new GradientPaint( x, y, NimRODLookAndFeel.brillo,
                                            x, y+h, NimRODLookAndFeel.sombra);
        break;
      case RIGHT:
    ...
    // Encima, pintamos la pesta�a con el color que le corresponde por profundidad
    if ( runCount > 1 ) {
   ...
   /**
    * Este metodo devuelve un tama�o mas grande de lo necesario, haciendoer hueco para
    * la decoracion.
    */
  ...
  protected int calculateTabWidth( int tabPlacement, int tabIndex, FontMetrics metrics) {
   ...
   /**
    * Este metodo devuelve un tama�o mas grande de lo necesario, haciendo el hueco para
    * la decoracion.
    */
...
//				|| (selRect.x - 1 > w)      //  bug !!
    ...
    */
	...
	{
		return new NimRODTabbedPaneLayout();
	}   //  createLayoutManager

	/**
	 *  Layout Manager to overwrite TabRect size
	 */
	public class NimRODTabbedPaneLayout extends NimRODTabbedPaneUI.TabbedPaneLayout
	{
		/**
