 ...
 */
public class KompiereLabelUI extends MetalLabelUI
{
	/** Singleton				*/
    protected static KompiereLabelUI compiereLabelUI = new KompiereLabelUI();
     ...
     *	@return singleton
     */
    public static KompiereLabelUI createUI(JComponent c) 
    {
