...
public class NimRODLookAndFeel extends MetalLookAndFeel {
  ...
  protected void initClassDefaults( UIDefaults table) {
    ...
    table.put( "ComboBoxUI", "com.nilo.plaf.nimrod.KompiereComboBoxUI");
    table.put( "LabelUI", "com.nilo.plaf.nimrod.KompiereLabelUI");
  ...
  protected void initComponentDefaults( UIDefaults table) {
    ...
    table.put( "Tree.closedIcon", loadRes( "/com/nilo/plaf/nimrod/icons/TreeDirCerrado.png"));
    table.put( "Tree.openIcon", loadRes( "/com/nilo/plaf/nimrod/icons/TreeDirAbierto.png"));
    table.put( "Tree.leafIcon", loadRes( "/com/nilo/plaf/nimrod/icons/TreeFicheroIcon.png"));
    table.put( "Tree.EstructuraCollapsedIcon", loadRes( "/com/nilo/plaf/nimrod/icons/TreeCollapsedIcon.png"));
    table.put( "Tree.EstructuraExpandedIcon", loadRes( "/com/nilo/plaf/nimrod/icons/TreeExpandedIcon.png"));
    
    // Los dialogos de ficheros
    table.put( "FileView.directoryIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogDirCerrado.png"));
    table.put( "FileView.fileIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogFicheroIcon.png"));
    table.put( "FileView.floppyDriveIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogFloppyIcon.png"));
    table.put( "FileView.hardDriveIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogHDIcon.png"));
    table.put( "FileChooser.newFolderIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogNewDir.png"));
    table.put( "FileChooser.homeFolderIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogHome.png"));
    table.put( "FileChooser.upFolderIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogDirParriba.png"));
    table.put( "FileChooser.detailsViewIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogDetails.png"));
    table.put( "FileChooser.listViewIcon", loadRes( "/com/nilo/plaf/nimrod/icons/DialogList.png"));
    ...
    table.put( "Menu.checkIcon", loadRes( "/com/nilo/plaf/nimrod/icons/bordeMenu.png"));
    table.put( "MenuItem.checkIcon", loadRes( "/com/nilo/plaf/nimrod/icons/bordeMenu.png"));
    table.put( "MenuCheckBox.iconBase", loadRes( "/com/nilo/plaf/nimrod/icons/MenuCheckBoxBase.png"));
    table.put( "MenuCheckBox.iconTick", loadRes( "/com/nilo/plaf/nimrod/icons/MenuCheckBoxTick.png"));
    table.put( "MenuRadioButton.iconBase", loadRes( "/com/nilo/plaf/nimrod/icons/MenuRadioBase.png"));
    table.put( "MenuRadioButton.iconTick", loadRes( "/com/nilo/plaf/nimrod/icons/MenuRadioTick.png"));
    table.put( "CheckBox.iconBase", loadRes( "/com/nilo/plaf/nimrod/icons/CheckBoxBase.png"));
    table.put( "CheckBox.iconTick", loadRes( "/com/nilo/plaf/nimrod/icons/CheckBoxTick.png"));
    table.put( "RadioButton.iconBase", loadRes( "/com/nilo/plaf/nimrod/icons/RadioButtonBase.png"));
    table.put( "RadioButton.iconTick", loadRes( "/com/nilo/plaf/nimrod/icons/RadioButtonTick.png"));
    
    // Los iconillos de los dialogos
    table.put( "OptionPane.errorIcon", loadRes( "/com/nilo/plaf/nimrod/icons/Error.png"));
    table.put( "OptionPane.informationIcon", loadRes( "/com/nilo/plaf/nimrod/icons/Inform.png"));
    table.put( "OptionPane.warningIcon", loadRes( "/com/nilo/plaf/nimrod/icons/Warn.png"));
    table.put( "OptionPane.questionIcon", loadRes( "/com/nilo/plaf/nimrod/icons/Question.png"));
    ...
    table.put( "Slider.horizontalThumbIconImage", loadRes( "/com/nilo/plaf/nimrod/icons/HorizontalThumbIconImage.png"));
    table.put( "Slider.verticalThumbIconImage", loadRes( "/com/nilo/plaf/nimrod/icons/VerticalThumbIconImage.png"));
