...
public class NimRODSplitPaneDivider extends BasicSplitPaneDivider {
  ...
  protected JButton createRightOneTouchButton() {
    JButton b = new Boton( Boton.DER, super.splitPane, super.ONE_TOUCH_SIZE);
  ...
  protected JButton createLeftOneTouchButton() {
    JButton b = new Boton( Boton.IZQ, super.splitPane, super.ONE_TOUCH_SIZE);
    Boolean boo = ((Boolean)UIManager.get( "SplitPane.oneTouchButtonsOpaque"));
    if ( boo != null ) {
      b.setOpaque( boo.booleanValue());
    }
  ...
  public void paint( Graphics g) {
    ...
    if ( super.splitPane.getOrientation() == JSplitPane.VERTICAL_SPLIT ) {
    	grad = new GradientPaint( 0,0, NimRODLookAndFeel.brillo, 
                                0,getHeight(), NimRODLookAndFeel.sombra);
		}
		else {
    	grad = new GradientPaint( 0,0, NimRODLookAndFeel.brillo, 
                                getWidth(),0, NimRODLookAndFeel.sombra);
		}
