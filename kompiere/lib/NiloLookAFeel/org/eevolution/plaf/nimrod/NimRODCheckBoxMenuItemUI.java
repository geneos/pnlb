...
/**
 * Esta clase implementa los CheckBox dentro de los menus desplegables.
...
public class NimRODCheckBoxMenuItemUI extends BasicCheckBoxMenuItemUI {
  public static ComponentUI createUI( JComponent x) {
    return new NimRODCheckBoxMenuItemUI();
  }
  ...
  protected void paintBackground( Graphics g, JMenuItem menuItem, Color bgColor) {
    NimRODLookAndFeel.pintaBarraMenu( g, menuItem, bgColor);
  }
}
