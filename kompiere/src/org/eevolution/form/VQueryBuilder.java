...
public class VQueryBuilder extends CPanel
...
{	
	...
	public void actionPerformed (ActionEvent e)
	{
		if (e.getActionCommand().equals(ConfirmPanel.A_OK))
		{
			...
			QueryS=Env.getContext(Env.getCtx(),"Query");
...
//							RV_Columns.save();
						...
						org.compiere.model.X_AD_ReportView View = new org.compiere.model.X_AD_ReportView(Env.getCtx(),0,null);
						View.setName(VName);
						...
						//Proceso
						org.compiere.model.MProcess Process = new org.compiere.model.MProcess(Env.getCtx(),0,null);
						...
						//Menu
						org.compiere.model.MMenu Menu= new org.compiere.model.MMenu(Env.getCtx(),0,null);
						Menu.setName(VName);
