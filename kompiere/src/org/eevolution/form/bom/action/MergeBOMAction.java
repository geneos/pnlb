...
public class MergeBOMAction extends PopupAction {
    ...
    private void mergeBOMFrom(DefaultMutableTreeNode node) {
    	...
    	MMPCProductBOM targetBOM = new MMPCProductBOM(Env.getCtx(), 0, null);
    ...
    private void createBOMLine(int bomId, DefaultMutableTreeNode node) {
    	...
    	MMPCProductBOMLine targetLine = new MMPCProductBOMLine(Env.getCtx(),0,null);
        
    	targetLine.setMPC_Product_BOM_ID(bomId);
