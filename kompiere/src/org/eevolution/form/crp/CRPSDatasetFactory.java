...
public abstract class CRPSDatasetFactory extends CRPReasoner implements CRPModel {
	...
	protected boolean generate(Timestamp start, Timestamp end, MResource r) {
	     ...
	     while(end.after(dateTime) || end.equals(dateTime)) {
	    	...
	    	load = isResourceAvailable(dateTime, r) ? calculateLoad(dateTime, r, null) : BigDecimal.ZERO;
                ...
                /*
                **  En este punto es donde debería de generar los gráficoa cada 7 dias en el período establecido  
                **  habría que considerar cuando end = dateTime que tal vez no es 7 dias y graficar ese ultimo período.
                */
                ...
                {
                    /*
                    **  En este punto hago la verificacón de la semana y tambien llamo a armar el arbol en función del acumulado
                    **  semanal.
                    **  VIT4B - 14/12/2006
                    */
                    ...
                    // Aquí no deberia de verificar por la disponibilidad en ese dia puesto que al ser una cumulado debería de registrarlo de todos modos.
	...
	protected HashMap addTreeNodes(Timestamp dateTime, DefaultMutableTreeNode root, MResource r, int days) {
                ...
                /*
                **  En este punto debería tomar la fecha y agregar los hijos correspondientes
		...
		root.add(parent);
                ...
                for(int ind = 0; ind < days; ind++) {
                    ...
                    for(int i = 0; i < orders.length; i++) {
                             ...
                             *      VIT4B 11/12/2007
                             *      
                             *      Modificación para que tome la referencia a los nodos de la 
