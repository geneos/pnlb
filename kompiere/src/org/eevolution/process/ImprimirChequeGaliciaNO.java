 ...
 */
public class ImprimirChequeGaliciaNO extends SvrProcess {
    ...
    protected String doIt() throws Exception {
        ...
        UtilProcess.initViewer("Impresion de Cheques Galicia No a la orden", p_instance, this.getProcessInfo());
        return "success";        
