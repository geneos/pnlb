 ...
 */
public class CopyFromProfileBOM extends SvrProcess
{
	/**	The Order				*/
	...
	protected String doIt() throws Exception
	{
		...
		if (p_MPC_ProfileBOM_ID == 0)
			throw new IllegalArgumentException("Source MPC_ProfileBOM_ID == 0");
                ...
                borrars = new StringBuffer("Delete From MPC_ProfileBOM_Product where MPC_ProfileBOM_ID=" + To_MPC_ProfileBOM_ID);
                DB.executeUpdate(borrars.toString());
                
                borrars = new StringBuffer("Delete From MPC_ProfileBOM_Selected where MPC_ProfileBOM_ID=" + To_MPC_ProfileBOM_ID);
                DB.executeUpdate(borrars.toString());                
