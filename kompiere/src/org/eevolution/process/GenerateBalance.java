...
public class GenerateBalance extends SvrProcess{
    ...
    protected void prepare() {
        ...
        if (para[1].getParameterName().equals("FECHAD"))
   		{	
   			fromDate = (Timestamp)para[1].getParameter();
       	   	toDate=(Timestamp)para[1].getParameter_To();
       	   	
       	   	num_hoja= ((BigDecimal) para[2].getParameter()).longValue();
       	}
        else
        	num_hoja= ((BigDecimal) para[1].getParameter()).longValue();
