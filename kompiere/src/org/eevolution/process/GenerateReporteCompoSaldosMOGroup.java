 ...
 */
public class GenerateReporteCompoSaldosMOGroup extends SvrProcess{
...
protected String doIt() throws Exception {
    ...
    if (rs.next())
    {
	    ...
	    UtilProcess.initViewer("Composición Saldos Grupo Socio de Negocio moneda Original",0,getProcessInfo());
	    return "";
	}
	...
	*/
    ...
    private String getSqlWhere(String param1, String param2, String param3, String param4){
		...
		if (toGroupPartner!=null && fromGroupPartner!=null)
			sqlWhere+= " AND cbp." + CBP + "  >= ? AND b." + CBP + " <= ?";
