...
public class GenerateRetencionesPago extends SvrProcess{
    ...
    protected void pie() throws Exception{
        ...
        while (rs.next()) {
            ...
            pstmtInsert.setString(4, "Régimen: "+rs.getString(1)+"/"+descripcion);
            ...
            // para las quintas líneas
                ...
                pstmtInsert3.setLong(3, p_PInstance_ID);
                pstmtInsert3.setString(4, "Total Régimen: "+rs.getString(1)+"/"+descripcion);
    ...
    protected void cabecera(){
        try {
                ...
                try {
                        ...
                        pstmtInsert.setString(6, "Listado de Retenciones de "+getRetencion()+" Realizadas período "+getFecha(fromDate)+" - "+getFecha(toDate));
