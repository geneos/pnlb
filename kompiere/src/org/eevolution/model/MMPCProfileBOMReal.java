 ...
 */
public class MMPCProfileBOMReal extends X_MPC_ProfileBOM_Real
{
	/**
	 ...
	 */
	public MMPCProfileBOMReal(Properties ctx, int MPC_ProfileBOM_Real_ID,String trxName)
	{
...
//			setPlannedQty (Env.ZERO);
	 ...
	 * 	@param rs result set
	 */
	public MMPCProfileBOMReal(Properties ctx, ResultSet rs,String trxName)
	{
	 ...
	 */
	public MMPCProfileBOMReal(MMPCProfileBOM profile, String trxName)
	{
		this (profile.getCtx(), 0,trxName);
...
//	{
//		return DB.getSQLValue("SELECT COALESCE(MAX(Line),0)+10 FROM MPC_ProfileBOM_Real WHERE MPC_ProfileBOM_ID=?", getMPC_ProfileBOM_ID());
//	}	//	getLineFromProject
