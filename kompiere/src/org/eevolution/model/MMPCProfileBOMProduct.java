...
//			setPlannedQty (Env.ZERO);
	 ...
	 */
	public MMPCProfileBOMProduct(MMPCProfileBOM profile,String trxName)
	{
	...
	{
		return DB.getSQLValue(null,"SELECT COALESCE(MAX(Line),0)+10 FROM MPC_ProfileBOM_Product WHERE MPC_ProfileBOM_ID=?", getMPC_ProfileBOM_ID());
	}	//	getLineFromProject
