...
public class XML2ADHandler extends DefaultHandler {
	...
	else if (elementValue.equals("compiereAD")) {
	    compiereAD = true;
	}
	// compieredata element.
	// some fields i.e. "table" are commons.
	else if (elementValue.equals("compieredata")) {
	    compieredata = true;
	...
	// column element.
		...
		m_ColumnSeqNo = m_ColumnSeqNo+10;
                m_Column.setIsEncrypted(m_Column.ISENCRYPTED_NotEncrypted);
	...
	// row element, compieredata
	    ...
	    ctx.setProperty("compieredataTable_ID", String.valueOf(getID("AD_Table", d_tablename)));
