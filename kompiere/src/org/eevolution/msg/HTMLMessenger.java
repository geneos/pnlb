...
public class HTMLMessenger {
	...
	final protected String MPCORDER_INFO_PATTERN = 	
			"<html><H1 align=\"CENTER\">"+Msg.translate(Env.getCtx(), "MPC_Order_ID")+"</H1>"+
			"<table cellpadding=\"5\" cellspacing=\"5\">"+
	...
	final protected String MPCORDER_HEADER_INFO_PATTERN = 	
	...
	final protected String MPCORDER_LINE_INFO_PATTERN = 	
		"<html>"+
		"<table cellpadding=\"5\" cellspacing=\"5\">"+
		"<tr>"+
		"<td>{0}</td>"+
	...
	final protected String BOM_INFO_PATTERN = 	
		"<html><H1 align=\"CENTER\">"+Msg.translate(Env.getCtx(), "MPC_Product_BOM_ID")+"</H1>"+
		"<table cellpadding=\"5\" cellspacing=\"5\">"+
		"<tr><td><b>"+Msg.translate(Env.getCtx(), "DocumentNo")+":</b></td><td>{0}</td></tr>"+
		"<tr><td><b>"+Msg.translate(Env.getCtx(), "MPC_Product_BOM_ID")+":</b></td><td>{1}</td></tr>"+
	...
	public String getMfcOrderInfo(MMPCOrder o) {
		...
		return MessageFormat.format(MPCORDER_INFO_PATTERN, obj);	    	
	}
