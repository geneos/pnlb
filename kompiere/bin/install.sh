...
export COMPIERE_HOME=/app/compiere/e-evolution/252d/install/build/Compiere2
...
if [ $COMPIERE_HOME ]; then
  CLASSPATH=$COMPIERE_HOME/lib/Compiere.jar:$COMPIERE_HOME/lib/CompiereCLib.jar:$COMPIERE_HOME/lib/CMPCS.jar:$CLASSPATH
else
  CLASSPATH=lib/Compiere.jar:lib/CompiereCLib.jar:lib/CMPCS.jar:$CLASSPATH
