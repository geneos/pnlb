...
public final class InfoProduct extends Info implements ActionListener
{
	...
	private void initInfo (String value, int M_Warehouse_ID, int M_PriceList_ID)
	{
		...
		/*
                 *  Zynnia 01/08/2012
                 *  Comentamos las lineas que setean los valores por defecto 
                 *  con los que comienzan el almacen y la lista de precios. De 
                 *  este modo, estos campos empiezan en blanco.
                 */
                //	Set Warehouse
