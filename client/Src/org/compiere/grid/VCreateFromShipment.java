 ...
 *
 *  @author Jorg Janke
 *  @version  $Id: VCreateFromShipment.java,v 1.32 2005/12/13 00:15:43 jjanke Exp $
 */
public class VCreateFromShipment extends VCreateFrom implements VetoableChangeListener
{
	...
	protected boolean save()
	{
		...
		//BISion - Santiago Ibañez - 17/06/2009
        //Solo se chequea el umbral para los que se generan desde ordenes de compra
        inout.setCHECKUMBRAL(true);
				...
				if (C_OrderLine_ID != 0)
				{
					...
					if (ol.getQtyEntered().compareTo(ol.getQtyOrdered()) != 0)
					{
						...
						iol.setC_UOM_ID(ol.getC_UOM_ID());
                                        ...
                                        /* 
                                        * Zynnia 02/01/2013
                                        * Comentado para que no asigne la partida anterior y se evite el error de partidas duplicadas
                                        * 
                                        */                                        
