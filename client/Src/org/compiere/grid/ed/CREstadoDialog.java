 ...
 */
public class CREstadoDialog extends CDialog
	implements ActionListener
{
	 ...
	 */
	public CREstadoDialog (Frame frame, int WindowNo, String st)
	{
		...
		{
			log.log(Level.SEVERE, "CREstadoDialog" + ex);
		}
		//	Dynamic Init
		if (!initStates ())
		{
	 ...
	 */
     private boolean initStates ()
	 {
    	...
    	CLabel actual = new CLabel(CREstado.getNameState(m_State.charAt(0)));
    	...
    	proxEstados.setMandatory(true);
     	...
     	if (m_State.equals("C"))
     	{
     		proxEstados.addItem(new ValueNamePair("P",CREstado.getNameState('P')));
		}
		if (m_State.equals("D"))
		{
			proxEstados.addItem(new ValueNamePair("P",CREstado.getNameState('P')));
	...
	public void actionPerformed(ActionEvent e)
	{
        ...
        /** BISion - 09/01/2009 - Santiago Ibañez
 ...
 */
final class CREstadoDialog_mouseAdapter extends java.awt.event.MouseAdapter
{
	/**
	 *	Constructor
	 *  @param adaptee adaptee
	 */
	CREstadoDialog_mouseAdapter(CREstadoDialog adaptee)
	{
		this.adaptee = adaptee;
	}	//	VPAttributeDialog_mouseAdapter

	private CREstadoDialog adaptee;
