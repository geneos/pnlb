...
**/
		...
		else if (displayType == DisplayType.PAttribute)
		{
			...
			editor = attrib;
                ...
                /** BISion - 08/01/2009 - Santiago Ibañez
                 * Modificacion realizada para fabricar dialogs para estados
                 * de cheques.
                 */
                //Estado Cheques recibidos
        else if (displayType == DisplayType.EstadoChequesRecibidos)
		{
			CREstado estado = new CREstado (mandatory, readOnly, updateable, WindowNo);
			estado.setName(columnName);
			estado.setField (mField);
			editor = estado;
		}
        else if (displayType == DisplayType.EstadoChequesPropios)
		{
			CPEstado estado = new CPEstado (mandatory, readOnly, updateable, WindowNo);
			estado.setName(columnName);
			estado.setField (mField);
			editor = estado;
		}        
