 ...
 *  @author Santiago
 */
public class CREstado extends JComponent
	implements VEditor, ActionListener
{
	 ...
	 */
	public CREstado (boolean mandatory, boolean isReadOnly, boolean isUpdateable, 
		int WindowNo)
	{
		super.setName("STATE");
		m_WindowNo = WindowNo;
	...
	//	Popup
		m_text.addMouseListener(new CREstado_mouseAdapter(this));
		menuEditor = new CMenuItem("Estado Cheques Recibidos", Env.getImageIcon("Zoom16.gif"));
	...
	{             
		...
		CREstadoDialog ed = new CREstadoDialog (Env.getFrame (this), m_WindowNo,(String)getValue());
        if (ed.changed())
        {
            ...
            if ((String)getValue() == "C" ||(String)getValue() == "D")
 ...
 *	Mouse Listener
 */
final class CREstado_mouseAdapter extends MouseAdapter
{
	/**
	 *	Constructor
	 *  @param adaptee adaptee
	 */
	CREstado_mouseAdapter(CREstado adaptee)
	{
		this.adaptee = adaptee;
	}	//	VPAttribute_mouseAdapter

	private CREstado adaptee;
