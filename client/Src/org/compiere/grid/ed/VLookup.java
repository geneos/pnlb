 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: VLookup.java,v 1.85 2005/12/13 00:15:42 jjanke Exp $
 */
	...
	private void actionZoom (Object selectedItem)
	{
		...
		if (zoomQuery == null || value != null)
		{
			...
			zoomQuery.setRecordCount(1);	//	guess
                ...
                // fjviejo e-evolution zoom manufactura
                int AD_Window_ID=0;

              // String tab = Env.getContext(Env.getCtx(),"WindowName");
                int tab2 = Env.getContextAsInt(Env.getCtx(), m_lookup.getWindowNo() +"|3|AD_Tab_ID");

                int tab =Env.getContextAsInt(Env.getCtx(), m_lookup.getWindowNo() +"|1|AD_Tab_ID");
                System.out.println("*****  evntana look.getwno : " +m_columnName  +" tab " +tab +" tab2 : "+tab2);
                if (tab==1000029 && m_columnName.equals("AD_Workflow_ID"))// || (tab2==1000034 && m_columnName.equals("AD_WorkFlow_ID")))
                {
                    AD_Window_ID=1000021;
                    System.out.println("***** ENTRA a columna workflow y tab 29");
                }
                else
                {
                // fjviejo e-evolution zoom manufactura
