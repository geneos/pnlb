 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: VPayment.java,v 1.49 2005/12/27 06:18:36 jjanke Exp $
 */
	...
	implements ActionListener
{
	...
	//begin e-evolution vpj-cd 02 Mar 2006
	private VDate sDateField;
	private CLabel sDateLabel = new CLabel();
	//end e-evolution vpj-cd 02 Mar 2006
	...
	private void jbInit() throws Exception
	{
		...
		//begin vpj-cd e-evolution.com 02 Mar 2006
		sDateField = new VDate("DateAcct", true, false, true, DisplayType.Date, "DateAcct");
		sDateLabel.setText(Msg.translate(Env.getCtx(), "DateAcct"));
		sPanel.add(sDateField,  new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 2, 5), 0, 0));
		sPanel.add(sDateLabel,  new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0
				,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 0, 2, 0), 0, 0));
		//end vpj-cd e-evolution.com 02 Mar 2006
		//
	...
	private boolean saveChanges()
	{
		...
		if ("KTSD".indexOf(newPaymentRule) != -1)
		{
			...
			//begin vpj-cd e-evolution 02 Mar 2006
			if (newPaymentRule.equals(MOrder.PAYMENTRULE_Check))			
			m_mPayment.setDateAcct((Timestamp)sDateField.getValue());
			//end vpj-cd e-evolution 02 Mar 2006
			m_mPayment.save();
