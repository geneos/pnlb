...
public class Language implements Serializable
{
    ...
    //begin e-evolution vpj 30 nov 1005
    private static final String AD_Language_mx_ES = "es_MX";
    //end 
	...
	static private Language[]   s_languages = {
		...
		new Language ("Espa\u00f1ol",
			...
			MediaSize.ISO.A4),
        //begin vpj-cd AD_Language_es_ES 15 Nov 2005
        new Language ("Espa\u00f1ol (MX)",
			AD_Language_mx_ES,  new Locale("es","MX"), new Boolean(false), "dd/MM/yyyy",
			MediaSize.ISO.A4),
        //end e-evolution           
		new Language ("Farsi",
