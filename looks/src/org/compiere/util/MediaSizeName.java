...
public class MediaSizeName extends Media {
   ...
   /**
    ...
    public static final MediaSizeName
	CHEQUES_STANDARDBANK = new MediaSizeName(73);
    
    public static final MediaSizeName
	CHEQUES_HSBC = new MediaSizeName(74);
    
    
    public static final MediaSizeName
	CHEQUES_GALICIA = new MediaSizeName(75);
