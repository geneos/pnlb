 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: RequestServlet.java,v 1.33 2006/01/11 06:55:19 jjanke Exp $
 */
		...
		throws ServletException, IOException
	{
		...
		if (R_Request_ID == 0)
		{
			...
			req.setAD_User_ID(wu.getAD_User_ID());
                        // fjviejo e-evolution bug fix request next action
                        Timestamp today=new Timestamp(System.currentTimeMillis());
                        req.setDateNextAction(today);
                        // fjviejo e-evolution bug fix request next action end
			if (C_Order_ID > 0)
