...
@Rem begin vpj-cd e-evolution 03/30/2005 CMPCS
@Rem Set CLASSPATH=lib\Compiere.jar;lib\CompiereCLib.jar;%CLASSPATH%
@Set CLASSPATH=lib\Compiere.jar;lib\CompiereCLib.jar;lib\Kompiere.jar;%COMPIERE_HOME%\lib\iText-5.0.6.jar;lib\jxl.jar;lib\ZynCompiere.jar;%CLASSPATH%
@Rem end vpj-cd e-evolution 03/30/2005 CMPCS
...
:COMPIERE_HOME_OK
@Rem begin vpj-cd e-evolution 03/30/2005 CMPCS
@Rem @Set CLASSPATH=%COMPIERE_HOME%\lib\Compiere.jar;%COMPIERE_HOME%\lib\CompiereCLib.jar;%CLASSPATH%
@Set CLASSPATH=%COMPIERE_HOME%\lib\Compiere.jar;%COMPIERE_HOME%\lib\CompiereCLib.jar;%COMPIERE_HOME%\lib\Kompiere.jar;%COMPIERE_HOME%\lib\iText-5.0.6.jar;%COMPIERE_HOME%\lib\jxl.jar;%COMPIERE_HOME%\lib\ZynCompiere.jar;%CLASSPATH%
@Rem end vpj-cd e-evolution 03/30/2005 CMPCS
