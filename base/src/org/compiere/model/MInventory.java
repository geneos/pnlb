...
public class MInventory extends X_M_Inventory implements DocAction {
    ...
    public String toString() {
        ...
        sb.append(get_ID()).append("-").append(getDocumentNo()).append(",M_Warehouse_ID=").append(getM_Warehouse_ID()).append("]");
        return sb.toString();
    }	//	toString
    ...
    public String completeIt() {
        ...
        inventoryCountUpdate(getUpdatedBy());
    ...
    public String inventoryCountUpdate(int AD_User_ID) {
        ...
        int delMA = MInventoryLineMA.deleteInventoryMA(getM_Inventory_ID(), get_TrxName());
        ...
        log.info("Update ASI without STOCK=" + no);
