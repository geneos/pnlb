...
public class MREGRETENRECIB extends X_C_REGRETEN_RECIB
{
	...
	{		
                    if (getIMPUESTO() == null){
                        JOptionPane.showMessageDialog(null,"Ingrese IMPUESTO","Error - Falta Parámetro", JOptionPane.ERROR_MESSAGE);
                        return false;
                    }	
		...
		{	if ((getJURISDICCION()==null) || (getJURISDICCION().equals(0)))
			{
				...
				{
					JOptionPane.showMessageDialog(null,"Ingrese Código de Jurisdicci�n","Error - Falta Parámetro", JOptionPane.ERROR_MESSAGE);
					return false;
				}
				else
				{
		...
		{	if (getIMPUESTO().equals(RETEN_IVA))
				...
				{
					JOptionPane.showMessageDialog(null,"Ingrese Regimen para IVA","Error - Falta Parámetro", JOptionPane.ERROR_MESSAGE);
					return false;
				}
				else
				{
				...
				if (getIMPUESTO().equals(RETEN_GAN))
					...
					{	
						JOptionPane.showMessageDialog(null,"Ingrese Regimen para Ganancias","Error - Falta Parámetro", JOptionPane.ERROR_MESSAGE);
						return false;
					}
					else
					{
				...
				{	if (getIMPUESTO().equals(RETEN_SUSS))
						...
						{	
							JOptionPane.showMessageDialog(null,"Ingrese Regimen para SUSS","Error - Falta Parámetro", JOptionPane.ERROR_MESSAGE);
							return false;
						}
						else
						{
