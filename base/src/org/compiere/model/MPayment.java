        ...
        implements DocAction, ProcessCall // End e-Evolution 20Abril2006
{
    ...
    protected boolean beforeSave(boolean newRecord) {
        ...
        if (DOCSTATUS_Drafted.equals(getDocStatus())) {
            ...
            } else // Si las monedas son iguales, la cotización es 1
            {
    ...
    public String completeIt() {
        ...
        for (int i = 0; i < valoresPago.size(); i++) {
            ...
            } else if (nuevoValorPago.getTIPO().equals(MVALORPAGO.TRANSFERENCIA)) {
    ...
    public String toString() {
        ...
        sb.append(get_ID()).append("-").append(getDocumentNo()).append(",Receipt=").append(isReceipt()).append(",PayAmt=").append(getPayAmt()).append(",Discount=").append(getDiscountAmt()).append(",WriteOff=").append(getWriteOffAmt()).append(",OverUnder=").append(getOverUnderAmt());
        return sb.toString();
    }	//	toString
