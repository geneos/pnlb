			...
			for (int j = 0; j < size; j++)
			{
				...
				if (displayType == DisplayType.Integer
					|| (DisplayType.isID(displayType) 
						&& (columnName.toUpperCase().endsWith("_ID") || columnName.toUpperCase().endsWith("_ACCT") 
							|| columnName.toUpperCase().equals("AD_KEY") || columnName.toUpperCase().equals("AD_DISPLAY"))) 
					|| columnName.toUpperCase().endsWith("ATEDBY"))
				{
