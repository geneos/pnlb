 ...
 */
public class ImportBankTransfers extends SvrProcess {
    ...
    /**	Bank Account			*/
    private int m_Account = 1000029;
    
    final String tableName = "I_BANK_TRANSFER";
    ...
    protected void prepare() {
        ...
        for (int i = 0; i < para.length; i++) {
            ...
            } else if (name.equals("Galicia_Account")) {
               m_Account = para[i].getParameterAsInt();
            } else if (name.equals("Date")) {
                m_Date = (Timestamp)para[i].getParameter();
            }else {
    ...
    protected String doIt() throws java.lang.Exception {
        ...
        try {
            ...
            //
            while (rs.next()) {
                X_I_BANK_TRANSFER imp = new X_I_BANK_TRANSFER(getCtx(), rs, get_TrxName());
                ...
                payment.setDescription("Pago generado automaticamente desde proceso \"Importar Transferencias Galicia\"");
                ...
                line.setC_BankAccount_ID(m_Account); //ICBC Hardcoded
                line.setTIPO(MVALORPAGO.TRANSFERENCIA);
                line.setDebitoDate(imp.getFECHA_PAGO());
                //Force to be generated on payment complete
                line.setNroTransferencia("00000000");

                if (!line.save()) {
                    imp.setI_ErrorMsg("ERROR creating Bank Transfer");
                    imp.setI_IsImported(false);
                    imp.save();
                    continue;
                } 
