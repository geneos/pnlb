 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: InventoryCountCreate.java,v 1.11 2005/10/26 00:37:42 jjanke Exp $
 */
public class InventoryCountCreate extends SvrProcess
{
		...
		int M_AttributeSetInstance_ID, BigDecimal QtyOnHand, int M_AttributeSet_ID)
	{
		...
		m_line = new MInventoryLine (m_inventory, M_Locator_ID, 
			M_Product_ID, M_AttributeSetInstance_ID, 
			QtyOnHand, QtyOnHand);		//	book/count
                //begin e-evolution vpj-cd 06 Abr 2005
		//if (m_line.save())
		//	return 1;
                if (!m_line.save())
			return 0;
                ...
                {    
                MInventoryLineMA ma = new MInventoryLineMA (m_line, 
				m_line.getM_AttributeSetInstance_ID(), QtyOnHand);
			if (!ma.save())
                            return 1;
                }
                 return 1;
                //return 0;
                //end e-evolution vpj-cd 06 Abr 2005                                        
