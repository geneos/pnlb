 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: ReplenishReport.java,v 1.10 2005/12/17 19:55:34 jjanke Exp $
 */
public class ReplenishReport extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		if (p_ReplenishmentCreate == null)
			return "OK";
		if (p_C_DocType_ID == 0)
			return "@FillMandatory@ @C_DocType_ID@";
		//
	...
	private void fillTable (MWarehouse wh) throws Exception
	{
		...
		{
			throw new CompiereUserError("No custom Replenishment class "
