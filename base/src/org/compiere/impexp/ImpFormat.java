 ...
 *
 *  @author Jorg Janke
 *  @version $Id: ImpFormat.java,v 1.24 2005/11/25 21:57:27 jjanke Exp $
 */
public final class ImpFormat
{
	...
	public void setTable (int AD_Table_ID)
	{
		...
		else if (m_AD_Table_ID == 533)		//	I_BPartner
		{
			m_tableUnique1 = "Value";				//	the key
                        // Begin e-Evolution 19/12/2005 ogi-cd
                            m_tableUnique1      = "Adress1";
                            m_tableUniqueParent = "Adress1";
                        // End e-Evolution 19/12/2005 ogi-cd
		}
	...
	//	log.config( "ImpFormat.updateDB - listSize=" + nodes.length);
		...
		if (getAD_Table_ID() == X_I_GLJournal.getTableId(X_I_GLJournal.Table_Name))
			AD_Org_ID = 0;
